...
// <auto-generated>
//  This code was generated by the following tool on 2024-04-14 17:25:21 GMT+00:00:
...
public static unsafe partial class SDL
{
    ...
    {
        public delegate* unmanaged<void*, CString, void*, ulong, int> Pointer;
    }
    ...
    public struct SDL_PenButtonEvent
    {
        ...
        public fixed byte _axes[24]; // float[6]

        public readonly Span<float> axes
        {
            get
            {
                fixed (SDL_PenButtonEvent* @this = &this)
                {
                    var pointer = &@this->_axes[0];
    ...
    public struct SDL_PenMotionEvent
    {
        ...
        public readonly Span<float> axes
        {
            get
            {
                fixed (SDL_PenMotionEvent* @this = &this)
                {
                    var pointer = &@this->_axes[0];
                    var span = new Span<float>(pointer, 6);
                    return span;
    ...
    public struct SDL_PenTipEvent
    {
        ...
        public readonly Span<float> axes
        {
            get
            {
                fixed (SDL_PenTipEvent* @this = &this)
                {
                    var pointer = &@this->_axes[0];
                    var span = new Span<float>(pointer, 6);
                    return span;
    ...
    public struct SDL_RendererInfo
    {
        ...
        public fixed byte _texture_formats[64]; // SDL_PixelFormatEnum[16]

        public readonly Span<SDL_PixelFormatEnum> texture_formats
        {
            get
            {
                fixed (SDL_RendererInfo* @this = &this)
                {
                    ...
                    var span = new Span<SDL_PixelFormatEnum>(pointer, 16);
                    return span;
                }
            }
        }
    ...
    public struct SDL_CameraDeviceID
    {
        ...
        public static implicit operator SDL_CameraDeviceID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_DialogFileCallback
    {
        ...
        public static implicit operator SDL_DialogFileCallback(FnPtr_VoidPtr_CStringPtr_Int_Void data) => new() { Data = data };
    }
    ...
    public struct SDL_EnumerateDirectoryCallback
    {
        ...
        public static implicit operator SDL_EnumerateDirectoryCallback(FnPtr_VoidPtr_CString_CString_Int data) => new() { Data = data };
    }
    ...
    public struct SDL_EnumeratePropertiesCallback
    {
        ...
        public static implicit operator SDL_EnumeratePropertiesCallback(FnPtr_VoidPtr_SDLPropertiesID_CString_Void data) => new() { Data = data };
    }
    ...
    public struct SDL_EventAction
    {
        ...
        public static implicit operator SDL_EventAction(SDL_eventaction data) => new() { Data = data };
    }
    ...
    public struct SDL_FingerID
    {
        ...
        public static implicit operator SDL_FingerID(ulong data) => new() { Data = data };
    }
    ...
    public struct SDL_HapticID
    {
        ...
        public static implicit operator SDL_HapticID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_KeyboardID
    {
        ...
        public static implicit operator SDL_KeyboardID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_PenID
    {
        ...
        public static implicit operator SDL_PenID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_PropertiesID
    {
        ...
        public static implicit operator SDL_PropertiesID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_Time
    {
        ...
        public static implicit operator SDL_Time(long data) => new() { Data = data };
    }
    ...
    public struct SDL_TimerID
    {
        ...
        public static implicit operator SDL_TimerID(uint data) => new() { Data = data };
    }
    ...
    public struct SDL_TouchID
    {
        ...
        public static implicit operator SDL_TouchID(ulong data) => new() { Data = data };
    }
    ...
    public struct SDL_WindowFlags
    {
        ...
        public static implicit operator SDL_WindowFlags(uint data) => new() { Data = data };
    }
