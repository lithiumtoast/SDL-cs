// <auto-generated>
//  This code was generated by the following tool on 2025-01-01 23:21:51 GMT-05:00:
...
public static unsafe partial class SDL
{
    ...
    public static int SDL_ALPHA_OPAQUE = (int)255;

    public static float SDL_ALPHA_OPAQUE_FLOAT = (float)1;

    public static int SDL_ALPHA_TRANSPARENT = (int)0;

    public static float SDL_ALPHA_TRANSPARENT_FLOAT = (float)0;

    public static uint SDL_BLENDMODE_ADD = (uint)2;

    public static uint SDL_BLENDMODE_ADD_PREMULTIPLIED = (uint)32;

    public static uint SDL_BLENDMODE_BLEND = (uint)1;

    public static uint SDL_BLENDMODE_BLEND_PREMULTIPLIED = (uint)16;

    public static uint SDL_BLENDMODE_INVALID = (uint)2147483647;

    public static uint SDL_BLENDMODE_MOD = (uint)4;

    public static uint SDL_BLENDMODE_MUL = (uint)8;

    public static uint SDL_BLENDMODE_NONE = (uint)0;

    public static int SDL_BUTTON_LEFT = (int)1;

    public static uint SDL_BUTTON_LMASK = (uint)1;

    public static int SDL_BUTTON_MIDDLE = (int)2;

    public static uint SDL_BUTTON_MMASK = (uint)2;

    public static int SDL_BUTTON_RIGHT = (int)3;

    public static uint SDL_BUTTON_RMASK = (uint)4;

    public static int SDL_BUTTON_X1 = (int)4;

    public static uint SDL_BUTTON_X1MASK = (uint)8;

    public static int SDL_BUTTON_X2 = (int)5;

    public static uint SDL_BUTTON_X2MASK = (uint)16;

    public static int SDL_CACHELINE_SIZE = (int)128;

    public static int SDL_DEBUG_TEXT_FONT_CHARACTER_SIZE = (int)8;

    public static float SDL_FLT_EPSILON = (float)1.1920928955078125E-07;

    public static int SDL_GL_CONTEXT_DEBUG_FLAG = (int)1;

    public static int SDL_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG = (int)2;

    public static int SDL_GL_CONTEXT_PROFILE_COMPATIBILITY = (int)2;

    public static int SDL_GL_CONTEXT_PROFILE_CORE = (int)1;

    public static int SDL_GL_CONTEXT_PROFILE_ES = (int)4;

    public static int SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = (int)1;

    public static int SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE = (int)0;

    public static int SDL_GL_CONTEXT_RESET_ISOLATION_FLAG = (int)8;

    public static int SDL_GL_CONTEXT_RESET_LOSE_CONTEXT = (int)1;

    public static int SDL_GL_CONTEXT_RESET_NO_NOTIFICATION = (int)0;

    public static int SDL_GL_CONTEXT_ROBUST_ACCESS_FLAG = (int)4;

    public static uint SDL_GLOB_CASEINSENSITIVE = (uint)1;

    public static uint SDL_GPU_BUFFERUSAGE_COMPUTE_STORAGE_READ = (uint)16;

    public static uint SDL_GPU_BUFFERUSAGE_COMPUTE_STORAGE_WRITE = (uint)32;

    public static uint SDL_GPU_BUFFERUSAGE_GRAPHICS_STORAGE_READ = (uint)8;

    public static uint SDL_GPU_BUFFERUSAGE_INDEX = (uint)2;

    public static uint SDL_GPU_BUFFERUSAGE_INDIRECT = (uint)4;

    public static uint SDL_GPU_BUFFERUSAGE_VERTEX = (uint)1;

    public static uint SDL_GPU_COLORCOMPONENT_A = (uint)8;

    public static uint SDL_GPU_COLORCOMPONENT_B = (uint)4;

    public static uint SDL_GPU_COLORCOMPONENT_G = (uint)2;

    public static uint SDL_GPU_COLORCOMPONENT_R = (uint)1;

    public static uint SDL_GPU_SHADERFORMAT_DXBC = (uint)4;

    public static uint SDL_GPU_SHADERFORMAT_DXIL = (uint)8;

    public static int SDL_GPU_SHADERFORMAT_INVALID = (int)0;

    public static uint SDL_GPU_SHADERFORMAT_METALLIB = (uint)32;

    public static uint SDL_GPU_SHADERFORMAT_MSL = (uint)16;

    public static uint SDL_GPU_SHADERFORMAT_PRIVATE = (uint)1;

    public static uint SDL_GPU_SHADERFORMAT_SPIRV = (uint)2;

    public static uint SDL_GPU_TEXTUREUSAGE_COLOR_TARGET = (uint)2;

    public static uint SDL_GPU_TEXTUREUSAGE_COMPUTE_STORAGE_READ = (uint)16;

    public static uint SDL_GPU_TEXTUREUSAGE_COMPUTE_STORAGE_SIMULTANEOUS_READ_WRITE = (uint)64;

    public static uint SDL_GPU_TEXTUREUSAGE_COMPUTE_STORAGE_WRITE = (uint)32;

    public static uint SDL_GPU_TEXTUREUSAGE_DEPTH_STENCIL_TARGET = (uint)4;

    public static uint SDL_GPU_TEXTUREUSAGE_GRAPHICS_STORAGE_READ = (uint)8;

    public static uint SDL_GPU_TEXTUREUSAGE_SAMPLER = (uint)1;

    public static uint SDL_HAPTIC_AUTOCENTER = (uint)131072;

    public static int SDL_HAPTIC_CARTESIAN = (int)1;

    public static uint SDL_HAPTIC_ANT = (uint)1;

    public static uint SDL_HAPTIC_CUSTOM = (uint)32768;

    public static uint SDL_HAPTIC_DAMPER = (uint)256;

    public static uint SDL_HAPTIC_FRICTION = (uint)1024;

    public static uint SDL_HAPTIC_GAIN = (uint)65536;

    public static uint SDL_HAPTIC_INERTIA = (uint)512;

    public static uint SDL_HAPTIC_INFINITY = (uint)4294967295;

    public static uint SDL_HAPTIC_LEFTRIGHT = (uint)2048;

    public static uint SDL_HAPTIC_PAUSE = (uint)524288;

    public static int SDL_HAPTIC_POLAR = (int)0;

    public static uint SDL_HAPTIC_RAMP = (uint)64;

    public static uint SDL_HAPTIC_RESERVED1 = (uint)4096;

    public static uint SDL_HAPTIC_RESERVED2 = (uint)8192;

    public static uint SDL_HAPTIC_RESERVED3 = (uint)16384;

    public static uint SDL_HAPTIC_SAWTOOTHDOWN = (uint)32;

    public static uint SDL_HAPTIC_SAWTOOTHUP = (uint)16;

    public static uint SDL_HAPTIC_SINE = (uint)2;

    public static int SDL_HAPTIC_SPHERICAL = (int)2;

    public static uint SDL_HAPTIC_SPRING = (uint)128;

    public static uint SDL_HAPTIC_SQUARE = (uint)4;

    public static uint SDL_HAPTIC_STATUS = (uint)262144;

    public static int SDL_HAPTIC_STEERING_AXIS = (int)3;

    public static uint SDL_HAPTIC_TRIANGLE = (uint)8;

    public static uint SDL_HAT_CENTERED = (uint)0;

    public static uint SDL_HAT_DOWN = (uint)4;

    public static uint SDL_HAT_LEFT = (uint)8;

    public static uint SDL_HAT_LEFTDOWN = (uint)12;

    public static uint SDL_HAT_LEFTUP = (uint)9;

    public static uint SDL_HAT_RIGHT = (uint)2;

    public static uint SDL_HAT_RIGHTDOWN = (uint)6;

    public static uint SDL_HAT_RIGHTUP = (uint)3;

    public static uint SDL_HAT_UP = (uint)1;

    public static CString SDL_HINT_ALLOW_ALT_TAB_WHILE_GRABBED = (CString)"SDL_ALLOW_ALT_TAB_WHILE_GRABBED";

    public static CString SDL_HINT_ANDROID_ALLOW_RECREATE_ACTIVITY = (CString)"SDL_ANDROID_ALLOW_RECREATE_ACTIVITY";

    public static CString SDL_HINT_ANDROID_BLOCK_ON_PAUSE = (CString)"SDL_ANDROID_BLOCK_ON_PAUSE";

    public static CString SDL_HINT_ANDROID_LOW_LATENCY_AUDIO = (CString)"SDL_ANDROID_LOW_LATENCY_AUDIO";

    public static CString SDL_HINT_ANDROID_TRAP_BACK_BUTTON = (CString)"SDL_ANDROID_TRAP_BACK_BUTTON";

    public static CString SDL_HINT_APP_ID = (CString)"SDL_APP_ID";

    public static CString SDL_HINT_APP_NAME = (CString)"SDL_APP_NAME";

    public static CString SDL_HINT_APPLE_TV_CONTROLLER_UI_EVENTS = (CString)"SDL_APPLE_TV_CONTROLLER_UI_EVENTS";

    public static CString SDL_HINT_APPLE_TV_REMOTE_ALLOW_ROTATION = (CString)"SDL_APPLE_TV_REMOTE_ALLOW_ROTATION";

    public static CString SDL_HINT_ASSERT = (CString)"SDL_ASSERT";

    public static CString SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE = (CString)"SDL_AUDIO_ALSA_DEFAULT_DEVICE";

    public static CString SDL_HINT_AUDIO_CATEGORY = (CString)"SDL_AUDIO_CATEGORY";

    public static CString SDL_HINT_AUDIO_CHANNELS = (CString)"SDL_AUDIO_CHANNELS";

    public static CString SDL_HINT_AUDIO_DEVICE_APP_ICON_NAME = (CString)"SDL_AUDIO_DEVICE_APP_ICON_NAME";

    public static CString SDL_HINT_AUDIO_DEVICE_SAMPLE_FRAMES = (CString)"SDL_AUDIO_DEVICE_SAMPLE_FRAMES";

    public static CString SDL_HINT_AUDIO_DEVICE_STREAM_NAME = (CString)"SDL_AUDIO_DEVICE_STREAM_NAME";

    public static CString SDL_HINT_AUDIO_DEVICE_STREAM_ROLE = (CString)"SDL_AUDIO_DEVICE_STREAM_ROLE";

    public static CString SDL_HINT_AUDIO_DISK_INPUT_FILE = (CString)"SDL_AUDIO_DISK_INPUT_FILE";

    public static CString SDL_HINT_AUDIO_DISK_OUTPUT_FILE = (CString)"SDL_AUDIO_DISK_OUTPUT_FILE";

    public static CString SDL_HINT_AUDIO_DISK_TIMESCALE = (CString)"SDL_AUDIO_DISK_TIMESCALE";

    public static CString SDL_HINT_AUDIO_DRIVER = (CString)"SDL_AUDIO_DRIVER";

    public static CString SDL_HINT_AUDIO_DUMMY_TIMESCALE = (CString)"SDL_AUDIO_DUMMY_TIMESCALE";

    public static CString SDL_HINT_AUDIO_FORMAT = (CString)"SDL_AUDIO_FORMAT";

    public static CString SDL_HINT_AUDIO_FREQUENCY = (CString)"SDL_AUDIO_FREQUENCY";

    public static CString SDL_HINT_AUDIO_INCLUDE_MONITORS = (CString)"SDL_AUDIO_INCLUDE_MONITORS";

    public static CString SDL_HINT_AUTO_UPDATE_JOYSTICKS = (CString)"SDL_AUTO_UPDATE_JOYSTICKS";

    public static CString SDL_HINT_AUTO_UPDATE_SENSORS = (CString)"SDL_AUTO_UPDATE_SENSORS";

    public static CString SDL_HINT_BMP_SAVE_LEGACY_FORMAT = (CString)"SDL_BMP_SAVE_LEGACY_FORMAT";

    public static CString SDL_HINT_CAMERA_DRIVER = (CString)"SDL_CAMERA_DRIVER";

    public static CString SDL_HINT_CPU_FEATURE_MASK = (CString)"SDL_CPU_FEATURE_MASK";

    public static CString SDL_HINT_DISPLAY_USABLE_BOUNDS = (CString)"SDL_DISPLAY_USABLE_BOUNDS";

    public static CString SDL_HINT_EMSCRIPTEN_ASYNCIFY = (CString)"SDL_EMSCRIPTEN_ASYNCIFY";

    public static CString SDL_HINT_EMSCRIPTEN_CANVAS_SELECTOR = (CString)"SDL_EMSCRIPTEN_CANVAS_SELECTOR";

    public static CString SDL_HINT_EMSCRIPTEN_KEYBOARD_ELEMENT = (CString)"SDL_EMSCRIPTEN_KEYBOARD_ELEMENT";

    public static CString SDL_HINT_ENABLE_SCREEN_KEYBOARD = (CString)"SDL_ENABLE_SCREEN_KEYBOARD";

    public static CString SDL_HINT_EVDEV_DEVICES = (CString)"SDL_EVDEV_DEVICES";

    public static CString SDL_HINT_EVENT_LOGGING = (CString)"SDL_EVENT_LOGGING";

    public static CString SDL_HINT_FILE_DIALOG_DRIVER = (CString)"SDL_FILE_DIALOG_DRIVER";

    public static CString SDL_HINT_FORCE_RAISEWINDOW = (CString)"SDL_FORCE_RAISEWINDOW";

    public static CString SDL_HINT_FRAMEBUFFER_ACCELERATION = (CString)"SDL_FRAMEBUFFER_ACCELERATION";

    public static CString SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES = (CString)"SDL_GAMECONTROLLER_IGNORE_DEVICES";

    public static CString SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT = (CString)"SDL_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT";

    public static CString SDL_HINT_GAMECONTROLLER_SENSOR_FUSION = (CString)"SDL_GAMECONTROLLER_SENSOR_FUSION";

    public static CString SDL_HINT_GAMECONTROLLERCONFIG = (CString)"SDL_GAMECONTROLLERCONFIG";

    public static CString SDL_HINT_GAMECONTROLLERCONFIG_FILE = (CString)"SDL_GAMECONTROLLERCONFIG_FILE";

    public static CString SDL_HINT_GAMECONTROLLERTYPE = (CString)"SDL_GAMECONTROLLERTYPE";

    public static CString SDL_HINT_GDK_TEXTINPUT_DEFAULT_TEXT = (CString)"SDL_GDK_TEXTINPUT_DEFAULT_TEXT";

    public static CString SDL_HINT_GDK_TEXTINPUT_DESCRIPTION = (CString)"SDL_GDK_TEXTINPUT_DESCRIPTION";

    public static CString SDL_HINT_GDK_TEXTINPUT_MAX_LENGTH = (CString)"SDL_GDK_TEXTINPUT_MAX_LENGTH";

    public static CString SDL_HINT_GDK_TEXTINPUT_SCOPE = (CString)"SDL_GDK_TEXTINPUT_SCOPE";

    public static CString SDL_HINT_GDK_TEXTINPUT_TITLE = (CString)"SDL_GDK_TEXTINPUT_TITLE";

    public static CString SDL_HINT_GPU_DRIVER = (CString)"SDL_GPU_DRIVER";

    public static CString SDL_HINT_HIDAPI_ENUMERATE_ONLY_CONTROLLERS = (CString)"SDL_HIDAPI_ENUMERATE_ONLY_CONTROLLERS";

    public static CString SDL_HINT_HIDAPI_IGNORE_DEVICES = (CString)"SDL_HIDAPI_IGNORE_DEVICES";

    public static CString SDL_HINT_HIDAPI_LIBUSB = (CString)"SDL_HIDAPI_LIBUSB";

    public static CString SDL_HINT_HIDAPI_LIBUSB_WHITELIST = (CString)"SDL_HIDAPI_LIBUSB_WHITELIST";

    public static CString SDL_HINT_HIDAPI_UDEV = (CString)"SDL_HIDAPI_UDEV";

    public static CString SDL_HINT_IME_IMPLEMENTED_UI = (CString)"SDL_IME_IMPLEMENTED_UI";

    public static CString SDL_HINT_IOS_HIDE_HOME_INDICATOR = (CString)"SDL_IOS_HIDE_HOME_INDICATOR";

    public static CString SDL_HINT_JOYSTICK_ALLOW_BACKGROUND_EVENTS = (CString)"SDL_JOYSTICK_ALLOW_BACKGROUND_EVENTS";

    public static CString SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES = (CString)"SDL_JOYSTICK_ARCADESTICK_DEVICES";

    public static CString SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_BLACKLIST_DEVICES = (CString)"SDL_JOYSTICK_BLACKLIST_DEVICES";

    public static CString SDL_HINT_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_DEVICE = (CString)"SDL_JOYSTICK_DEVICE";

    public static CString SDL_HINT_JOYSTICK_DIRECTINPUT = (CString)"SDL_JOYSTICK_DIRECTINPUT";

    public static CString SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES = (CString)"SDL_JOYSTICK_FLIGHTSTICK_DEVICES";

    public static CString SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_GAMECUBE_DEVICES = (CString)"SDL_JOYSTICK_GAMECUBE_DEVICES";

    public static CString SDL_HINT_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_GAMEINPUT = (CString)"SDL_JOYSTICK_GAMEINPUT";

    public static CString SDL_HINT_JOYSTICK_HIDAPI = (CString)"SDL_JOYSTICK_HIDAPI";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_COMBINE_JOY_CONS = (CString)"SDL_JOYSTICK_HIDAPI_COMBINE_JOY_CONS";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE = (CString)"SDL_JOYSTICK_HIDAPI_GAMECUBE";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE = (CString)"SDL_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_JOY_CONS = (CString)"SDL_JOYSTICK_HIDAPI_JOY_CONS";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_JOYCON_HOME_LED = (CString)"SDL_JOYSTICK_HIDAPI_JOYCON_HOME_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_LUNA = (CString)"SDL_JOYSTICK_HIDAPI_LUNA";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_NINTENDO_CLASSIC = (CString)"SDL_JOYSTICK_HIDAPI_NINTENDO_CLASSIC";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS3 = (CString)"SDL_JOYSTICK_HIDAPI_PS3";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER = (CString)"SDL_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS4 = (CString)"SDL_JOYSTICK_HIDAPI_PS4";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL = (CString)"SDL_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE = (CString)"SDL_JOYSTICK_HIDAPI_PS4_RUMBLE";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS5 = (CString)"SDL_JOYSTICK_HIDAPI_PS5";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS5_PLAYER_LED = (CString)"SDL_JOYSTICK_HIDAPI_PS5_PLAYER_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_PS5_RUMBLE = (CString)"SDL_JOYSTICK_HIDAPI_PS5_RUMBLE";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_SHIELD = (CString)"SDL_JOYSTICK_HIDAPI_SHIELD";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_STADIA = (CString)"SDL_JOYSTICK_HIDAPI_STADIA";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_STEAM = (CString)"SDL_JOYSTICK_HIDAPI_STEAM";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_STEAM_HOME_LED = (CString)"SDL_JOYSTICK_HIDAPI_STEAM_HOME_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_STEAM_HORI = (CString)"SDL_JOYSTICK_HIDAPI_STEAM_HORI";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_STEAMDECK = (CString)"SDL_JOYSTICK_HIDAPI_STEAMDECK";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_SWITCH = (CString)"SDL_JOYSTICK_HIDAPI_SWITCH";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_SWITCH_HOME_LED = (CString)"SDL_JOYSTICK_HIDAPI_SWITCH_HOME_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED = (CString)"SDL_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS = (CString)"SDL_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_WII = (CString)"SDL_JOYSTICK_HIDAPI_WII";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_WII_PLAYER_LED = (CString)"SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX = (CString)"SDL_JOYSTICK_HIDAPI_XBOX";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX_360 = (CString)"SDL_JOYSTICK_HIDAPI_XBOX_360";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED = (CString)"SDL_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_WIRELESS = (CString)"SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE = (CString)"SDL_JOYSTICK_HIDAPI_XBOX_ONE";

    public static CString SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED = (CString)"SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED";

    public static CString SDL_HINT_JOYSTICK_IOKIT = (CString)"SDL_JOYSTICK_IOKIT";

    public static CString SDL_HINT_JOYSTICK_LINUX_CLASSIC = (CString)"SDL_JOYSTICK_LINUX_CLASSIC";

    public static CString SDL_HINT_JOYSTICK_LINUX_DEADZONES = (CString)"SDL_JOYSTICK_LINUX_DEADZONES";

    public static CString SDL_HINT_JOYSTICK_LINUX_DIGITAL_HATS = (CString)"SDL_JOYSTICK_LINUX_DIGITAL_HATS";

    public static CString SDL_HINT_JOYSTICK_LINUX_HAT_DEADZONES = (CString)"SDL_JOYSTICK_LINUX_HAT_DEADZONES";

    public static CString SDL_HINT_JOYSTICK_MFI = (CString)"SDL_JOYSTICK_MFI";

    public static CString SDL_HINT_JOYSTICK_RAWINPUT = (CString)"SDL_JOYSTICK_RAWINPUT";

    public static CString SDL_HINT_JOYSTICK_RAWINPUT_CORRELATE_XINPUT = (CString)"SDL_JOYSTICK_RAWINPUT_CORRELATE_XINPUT";

    public static CString SDL_HINT_JOYSTICK_ROG_CHAKRAM = (CString)"SDL_JOYSTICK_ROG_CHAKRAM";

    public static CString SDL_HINT_JOYSTICK_THREAD = (CString)"SDL_JOYSTICK_THREAD";

    public static CString SDL_HINT_JOYSTICK_THROTTLE_DEVICES = (CString)"SDL_JOYSTICK_THROTTLE_DEVICES";

    public static CString SDL_HINT_JOYSTICK_THROTTLE_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_THROTTLE_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_WGI = (CString)"SDL_JOYSTICK_WGI";

    public static CString SDL_HINT_JOYSTICK_WHEEL_DEVICES = (CString)"SDL_JOYSTICK_WHEEL_DEVICES";

    public static CString SDL_HINT_JOYSTICK_WHEEL_DEVICES_EXCLUDED = (CString)"SDL_JOYSTICK_WHEEL_DEVICES_EXCLUDED";

    public static CString SDL_HINT_JOYSTICK_ZERO_CENTERED_DEVICES = (CString)"SDL_JOYSTICK_ZERO_CENTERED_DEVICES";

    public static CString SDL_HINT_KEYCODE_OPTIONS = (CString)"SDL_KEYCODE_OPTIONS";

    public static CString SDL_HINT_KMSDRM_DEVICE_INDEX = (CString)"SDL_KMSDRM_DEVICE_INDEX";

    public static CString SDL_HINT_KMSDRM_REQUIRE_DRM_MASTER = (CString)"SDL_KMSDRM_REQUIRE_DRM_MASTER";

    public static CString SDL_HINT_LOGGING = (CString)"SDL_LOGGING";

    public static CString SDL_HINT_MAC_BACKGROUND_APP = (CString)"SDL_MAC_BACKGROUND_APP";

    public static CString SDL_HINT_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK = (CString)"SDL_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK";

    public static CString SDL_HINT_MAC_OPENGL_ASYNC_DISPATCH = (CString)"SDL_MAC_OPENGL_ASYNC_DISPATCH";

    public static CString SDL_HINT_MAC_SCROLL_MOMENTUM = (CString)"SDL_MAC_SCROLL_MOMENTUM";

    public static CString SDL_HINT_MAIN_CALLBACK_RATE = (CString)"SDL_MAIN_CALLBACK_RATE";

    public static CString SDL_HINT_MOUSE_AUTO_CAPTURE = (CString)"SDL_MOUSE_AUTO_CAPTURE";

    public static CString SDL_HINT_MOUSE_DEFAULT_SYSTEM_CURSOR = (CString)"SDL_MOUSE_DEFAULT_SYSTEM_CURSOR";

    public static CString SDL_HINT_MOUSE_DOUBLE_CLICK_RADIUS = (CString)"SDL_MOUSE_DOUBLE_CLICK_RADIUS";

    public static CString SDL_HINT_MOUSE_DOUBLE_CLICK_TIME = (CString)"SDL_MOUSE_DOUBLE_CLICK_TIME";

    public static CString SDL_HINT_MOUSE_EMULATE_WARP_WITH_RELATIVE = (CString)"SDL_MOUSE_EMULATE_WARP_WITH_RELATIVE";

    public static CString SDL_HINT_MOUSE_FOCUS_CLICKTHROUGH = (CString)"SDL_MOUSE_FOCUS_CLICKTHROUGH";

    public static CString SDL_HINT_MOUSE_NORMAL_SPEED_SCALE = (CString)"SDL_MOUSE_NORMAL_SPEED_SCALE";

    public static CString SDL_HINT_MOUSE_RELATIVE_CLIP_INTERVAL = (CString)"SDL_MOUSE_RELATIVE_CLIP_INTERVAL";

    public static CString SDL_HINT_MOUSE_RELATIVE_CURSOR_VISIBLE = (CString)"SDL_MOUSE_RELATIVE_CURSOR_VISIBLE";

    public static CString SDL_HINT_MOUSE_RELATIVE_MODE_CENTER = (CString)"SDL_MOUSE_RELATIVE_MODE_CENTER";

    public static CString SDL_HINT_MOUSE_RELATIVE_MODE_WARP = (CString)"SDL_MOUSE_RELATIVE_MODE_WARP";

    public static CString SDL_HINT_MOUSE_RELATIVE_SPEED_SCALE = (CString)"SDL_MOUSE_RELATIVE_SPEED_SCALE";

    public static CString SDL_HINT_MOUSE_RELATIVE_SYSTEM_SCALE = (CString)"SDL_MOUSE_RELATIVE_SYSTEM_SCALE";

    public static CString SDL_HINT_MOUSE_RELATIVE_WARP_MOTION = (CString)"SDL_MOUSE_RELATIVE_WARP_MOTION";

    public static CString SDL_HINT_MOUSE_TOUCH_EVENTS = (CString)"SDL_MOUSE_TOUCH_EVENTS";

    public static CString SDL_HINT_MUTE_CONSOLE_KEYBOARD = (CString)"SDL_MUTE_CONSOLE_KEYBOARD";

    public static CString SDL_HINT_NO_SIGNAL_HANDLERS = (CString)"SDL_NO_SIGNAL_HANDLERS";

    public static CString SDL_HINT_OPENGL_ES_DRIVER = (CString)"SDL_OPENGL_ES_DRIVER";

    public static CString SDL_HINT_OPENGL_LIBRARY = (CString)"SDL_OPENGL_LIBRARY";

    public static CString SDL_HINT_OPENVR_LIBRARY = (CString)"SDL_OPENVR_LIBRARY";

    public static CString SDL_HINT_ORIENTATIONS = (CString)"SDL_ORIENTATIONS";

    public static CString SDL_HINT_POLL_SENTINEL = (CString)"SDL_POLL_SENTINEL";

    public static CString SDL_HINT_PREFERRED_LOCALES = (CString)"SDL_PREFERRED_LOCALES";

    public static CString SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE = (CString)"SDL_QUIT_ON_LAST_WINDOW_CLOSE";

    public static CString SDL_HINT_RENDER_DIRECT3D_THREADSAFE = (CString)"SDL_RENDER_DIRECT3D_THREADSAFE";

    public static CString SDL_HINT_RENDER_DIRECT3D11_DEBUG = (CString)"SDL_RENDER_DIRECT3D11_DEBUG";

    public static CString SDL_HINT_RENDER_DRIVER = (CString)"SDL_RENDER_DRIVER";

    public static CString SDL_HINT_RENDER_GPU_DEBUG = (CString)"SDL_RENDER_GPU_DEBUG";

    public static CString SDL_HINT_RENDER_GPU_LOW_POWER = (CString)"SDL_RENDER_GPU_LOW_POWER";

    public static CString SDL_HINT_RENDER_LINE_METHOD = (CString)"SDL_RENDER_LINE_METHOD";

    public static CString SDL_HINT_RENDER_METAL_PREFER_LOW_POWER_DEVICE = (CString)"SDL_RENDER_METAL_PREFER_LOW_POWER_DEVICE";

    public static CString SDL_HINT_RENDER_VSYNC = (CString)"SDL_RENDER_VSYNC";

    public static CString SDL_HINT_RENDER_VULKAN_DEBUG = (CString)"SDL_RENDER_VULKAN_DEBUG";

    public static CString SDL_HINT_RETURN_KEY_HIDES_IME = (CString)"SDL_RETURN_KEY_HIDES_IME";

    public static CString SDL_HINT_ROG_GAMEPAD_MICE = (CString)"SDL_ROG_GAMEPAD_MICE";

    public static CString SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED = (CString)"SDL_ROG_GAMEPAD_MICE_EXCLUDED";

    public static CString SDL_HINT_RPI_VIDEO_LAYER = (CString)"SDL_RPI_VIDEO_LAYER";

    public static CString SDL_HINT_SCREENSAVER_INHIBIT_ACTIVITY_NAME = (CString)"SDL_SCREENSAVER_INHIBIT_ACTIVITY_NAME";

    public static CString SDL_HINT_SHUTDOWN_DBUS_ON_QUIT = (CString)"SDL_SHUTDOWN_DBUS_ON_QUIT";

    public static CString SDL_HINT_STORAGE_TITLE_DRIVER = (CString)"SDL_STORAGE_TITLE_DRIVER";

    public static CString SDL_HINT_STORAGE_USER_DRIVER = (CString)"SDL_STORAGE_USER_DRIVER";

    public static CString SDL_HINT_THREAD_FORCE_REALTIME_TIME_CRITICAL = (CString)"SDL_THREAD_FORCE_REALTIME_TIME_CRITICAL";

    public static CString SDL_HINT_THREAD_PRIORITY_POLICY = (CString)"SDL_THREAD_PRIORITY_POLICY";

    public static CString SDL_HINT_TIMER_RESOLUTION = (CString)"SDL_TIMER_RESOLUTION";

    public static CString SDL_HINT_TOUCH_MOUSE_EVENTS = (CString)"SDL_TOUCH_MOUSE_EVENTS";

    public static CString SDL_HINT_TRACKPAD_IS_TOUCH_ONLY = (CString)"SDL_TRACKPAD_IS_TOUCH_ONLY";

    public static CString SDL_HINT_TV_REMOTE_AS_JOYSTICK = (CString)"SDL_TV_REMOTE_AS_JOYSTICK";

    public static CString SDL_HINT_VIDEO_ALLOW_SCREENSAVER = (CString)"SDL_VIDEO_ALLOW_SCREENSAVER";

    public static CString SDL_HINT_VIDEO_DISPLAY_PRIORITY = (CString)"SDL_VIDEO_DISPLAY_PRIORITY";

    public static CString SDL_HINT_VIDEO_DOUBLE_BUFFER = (CString)"SDL_VIDEO_DOUBLE_BUFFER";

    public static CString SDL_HINT_VIDEO_DRIVER = (CString)"SDL_VIDEO_DRIVER";

    public static CString SDL_HINT_VIDEO_DUMMY_SAVE_FRAMES = (CString)"SDL_VIDEO_DUMMY_SAVE_FRAMES";

    public static CString SDL_HINT_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK = (CString)"SDL_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK";

    public static CString SDL_HINT_VIDEO_FORCE_EGL = (CString)"SDL_VIDEO_FORCE_EGL";

    public static CString SDL_HINT_VIDEO_MAC_FULLSCREEN_SPACES = (CString)"SDL_VIDEO_MAC_FULLSCREEN_SPACES";

    public static CString SDL_HINT_VIDEO_MINIMIZE_ON_FOCUS_LOSS = (CString)"SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS";

    public static CString SDL_HINT_VIDEO_OFFSCREEN_SAVE_FRAMES = (CString)"SDL_VIDEO_OFFSCREEN_SAVE_FRAMES";

    public static CString SDL_HINT_VIDEO_SYNC_WINDOW_OPERATIONS = (CString)"SDL_VIDEO_SYNC_WINDOW_OPERATIONS";

    public static CString SDL_HINT_VIDEO_WAYLAND_ALLOW_LIBDECOR = (CString)"SDL_VIDEO_WAYLAND_ALLOW_LIBDECOR";

    public static CString SDL_HINT_VIDEO_WAYLAND_MODE_EMULATION = (CString)"SDL_VIDEO_WAYLAND_MODE_EMULATION";

    public static CString SDL_HINT_VIDEO_WAYLAND_MODE_SCALING = (CString)"SDL_VIDEO_WAYLAND_MODE_SCALING";

    public static CString SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR = (CString)"SDL_VIDEO_WAYLAND_PREFER_LIBDECOR";

    public static CString SDL_HINT_VIDEO_WAYLAND_SCALE_TO_DISPLAY = (CString)"SDL_VIDEO_WAYLAND_SCALE_TO_DISPLAY";

    public static CString SDL_HINT_VIDEO_WIN_D3DCOMPILER = (CString)"SDL_VIDEO_WIN_D3DCOMPILER";

    public static CString SDL_HINT_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR = (CString)"SDL_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR";

    public static CString SDL_HINT_VIDEO_X11_NET_WM_PING = (CString)"SDL_VIDEO_X11_NET_WM_PING";

    public static CString SDL_HINT_VIDEO_X11_NODIRECTCOLOR = (CString)"SDL_VIDEO_X11_NODIRECTCOLOR";

    public static CString SDL_HINT_VIDEO_X11_SCALING_FACTOR = (CString)"SDL_VIDEO_X11_SCALING_FACTOR";

    public static CString SDL_HINT_VIDEO_X11_VISUALID = (CString)"SDL_VIDEO_X11_VISUALID";

    public static CString SDL_HINT_VIDEO_X11_WINDOW_VISUALID = (CString)"SDL_VIDEO_X11_WINDOW_VISUALID";

    public static CString SDL_HINT_VIDEO_X11_XRANDR = (CString)"SDL_VIDEO_X11_XRANDR";

    public static CString SDL_HINT_VITA_ENABLE_BACK_TOUCH = (CString)"SDL_VITA_ENABLE_BACK_TOUCH";

    public static CString SDL_HINT_VITA_ENABLE_FRONT_TOUCH = (CString)"SDL_VITA_ENABLE_FRONT_TOUCH";

    public static CString SDL_HINT_VITA_MODULE_PATH = (CString)"SDL_VITA_MODULE_PATH";

    public static CString SDL_HINT_VITA_PVR_INIT = (CString)"SDL_VITA_PVR_INIT";

    public static CString SDL_HINT_VITA_PVR_OPENGL = (CString)"SDL_VITA_PVR_OPENGL";

    public static CString SDL_HINT_VITA_RESOLUTION = (CString)"SDL_VITA_RESOLUTION";

    public static CString SDL_HINT_VITA_TOUCH_MOUSE_DEVICE = (CString)"SDL_VITA_TOUCH_MOUSE_DEVICE";

    public static CString SDL_HINT_VULKAN_DISPLAY = (CString)"SDL_VULKAN_DISPLAY";

    public static CString SDL_HINT_VULKAN_LIBRARY = (CString)"SDL_VULKAN_LIBRARY";

    public static CString SDL_HINT_WAVE_CHUNK_LIMIT = (CString)"SDL_WAVE_CHUNK_LIMIT";

    public static CString SDL_HINT_WAVE_FACT_CHUNK = (CString)"SDL_WAVE_FACT_CHUNK";

    public static CString SDL_HINT_WAVE_RIFF_CHUNK_SIZE = (CString)"SDL_WAVE_RIFF_CHUNK_SIZE";

    public static CString SDL_HINT_WAVE_TRUNCATION = (CString)"SDL_WAVE_TRUNCATION";

    public static CString SDL_HINT_WINDOW_ACTIVATE_WHEN_RAISED = (CString)"SDL_WINDOW_ACTIVATE_WHEN_RAISED";

    public static CString SDL_HINT_WINDOW_ACTIVATE_WHEN_SHOWN = (CString)"SDL_WINDOW_ACTIVATE_WHEN_SHOWN";

    public static CString SDL_HINT_WINDOW_ALLOW_TOPMOST = (CString)"SDL_WINDOW_ALLOW_TOPMOST";

    public static CString SDL_HINT_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN = (CString)"SDL_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN";

    public static CString SDL_HINT_WINDOWS_CLOSE_ON_ALT_F4 = (CString)"SDL_WINDOWS_CLOSE_ON_ALT_F4";

    public static CString SDL_HINT_WINDOWS_ENABLE_MENU_MNEMONICS = (CString)"SDL_WINDOWS_ENABLE_MENU_MNEMONICS";

    public static CString SDL_HINT_WINDOWS_ENABLE_MESSAGELOOP = (CString)"SDL_WINDOWS_ENABLE_MESSAGELOOP";

    public static CString SDL_HINT_WINDOWS_ERASE_BACKGROUND_MODE = (CString)"SDL_WINDOWS_ERASE_BACKGROUND_MODE";

    public static CString SDL_HINT_WINDOWS_FORCE_SEMAPHORE_KERNEL = (CString)"SDL_WINDOWS_FORCE_SEMAPHORE_KERNEL";

    public static CString SDL_HINT_WINDOWS_GAMEINPUT = (CString)"SDL_WINDOWS_GAMEINPUT";

    public static CString SDL_HINT_WINDOWS_INTRESOURCE_ICON = (CString)"SDL_WINDOWS_INTRESOURCE_ICON";

    public static CString SDL_HINT_WINDOWS_INTRESOURCE_ICON_SMALL = (CString)"SDL_WINDOWS_INTRESOURCE_ICON_SMALL";

    public static CString SDL_HINT_WINDOWS_RAW_KEYBOARD = (CString)"SDL_WINDOWS_RAW_KEYBOARD";

    public static CString SDL_HINT_WINDOWS_USE_D3D9EX = (CString)"SDL_WINDOWS_USE_D3D9EX";

    public static CString SDL_HINT_X11_FORCE_OVERRIDE_REDIRECT = (CString)"SDL_X11_FORCE_OVERRIDE_REDIRECT";

    public static CString SDL_HINT_X11_WINDOW_TYPE = (CString)"SDL_X11_WINDOW_TYPE";

    public static CString SDL_HINT_X11_XCB_LIBRARY = (CString)"SDL_X11_XCB_LIBRARY";

    public static CString SDL_HINT_XINPUT_ENABLED = (CString)"SDL_XINPUT_ENABLED";

    public static uint SDL_INIT_AUDIO = (uint)16;

    public static uint SDL_INIT_CAMERA = (uint)65536;

    public static uint SDL_INIT_EVENTS = (uint)16384;

    public static uint SDL_INIT_GAMEPAD = (uint)8192;

    public static uint SDL_INIT_HAPTIC = (uint)4096;

    public static uint SDL_INIT_JOYSTICK = (uint)512;

    public static uint SDL_INIT_SENSOR = (uint)32768;

    public static uint SDL_INIT_VIDEO = (uint)32;

    public static int SDL_INVALID_UNICODE_CODEPOINT = (int)65533;

    public static int SDL_JOYSTICK_AXIS_MAX = (int)32767;

    public static int SDL_JOYSTICK_AXIS_MIN = (int)-32768;

    public static uint SDL_KMOD_ALT = (uint)768;

    public static uint SDL_KMOD_CAPS = (uint)8192;

    public static uint SDL_KMOD_CTRL = (uint)192;

    public static uint SDL_KMOD_GUI = (uint)3072;

    public static uint SDL_KMOD_LALT = (uint)256;

    public static uint SDL_KMOD_LCTRL = (uint)64;

    public static uint SDL_KMOD_LGUI = (uint)1024;

    public static uint SDL_KMOD_LSHIFT = (uint)1;

    public static uint SDL_KMOD_MODE = (uint)16384;

    public static uint SDL_KMOD_NONE = (uint)0;

    public static uint SDL_KMOD_NUM = (uint)4096;

    public static uint SDL_KMOD_RALT = (uint)512;

    public static uint SDL_KMOD_RCTRL = (uint)128;

    public static uint SDL_KMOD_RGUI = (uint)2048;

    public static uint SDL_KMOD_RSHIFT = (uint)2;

    public static uint SDL_KMOD_SCROLL = (uint)32768;

    public static uint SDL_KMOD_SHIFT = (uint)3;

    public static int SDL_MAJOR_VERSION = (int)3;

    public static uint SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT = (uint)2;

    public static uint SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT = (uint)1;

    public static uint SDL_MESSAGEBOX_BUTTONS_LEFT_TO_RIGHT = (uint)128;

    public static uint SDL_MESSAGEBOX_BUTTONS_RIGHT_TO_LEFT = (uint)256;

    public static uint SDL_MESSAGEBOX_ERROR = (uint)16;

    public static uint SDL_MESSAGEBOX_INFORMATION = (uint)64;

    public static uint SDL_MESSAGEBOX_WARNING = (uint)32;

    public static int SDL_MICRO_VERSION = (int)7;

    public static int SDL_MINOR_VERSION = (int)1;

    public static SDL_TouchID SDL_MOUSE_TOUCHID = (SDL_TouchID)18446744073709551615;

    public static uint SDL_PEN_INPUT_BUTTON_1 = (uint)2;

    public static uint SDL_PEN_INPUT_BUTTON_2 = (uint)4;

    public static uint SDL_PEN_INPUT_BUTTON_3 = (uint)8;

    public static uint SDL_PEN_INPUT_BUTTON_4 = (uint)16;

    public static uint SDL_PEN_INPUT_BUTTON_5 = (uint)32;

    public static uint SDL_PEN_INPUT_DOWN = (uint)1;

    public static uint SDL_PEN_INPUT_ERASER_TIP = (uint)1073741824;

    public static double SDL_PI_D = (double)3.141592653589793;

    public static float SDL_PI_F = (float)3.1415927410125732;

    public static CString SDL_PRILL_PREFIX = (CString)"ll";

    public static CString SDL_PRILLd = (CString)"lld";

    public static CString SDL_PRILLu = (CString)"llu";

    public static CString SDL_PRILLx = (CString)"llx";

    public static CString SDL_PRILLX = (CString)"llX";

    public static CString SDL_PROP_APP_METADATA_COPYRIGHT_STRING = (CString)"SDL.app.metadata.copyright";

    public static CString SDL_PROP_APP_METADATA_CREATOR_STRING = (CString)"SDL.app.metadata.creator";

    public static CString SDL_PROP_APP_METADATA_IDENTIFIER_STRING = (CString)"SDL.app.metadata.identifier";

    public static CString SDL_PROP_APP_METADATA_NAME_STRING = (CString)"SDL.app.metadata.name";

    public static CString SDL_PROP_APP_METADATA_TYPE_STRING = (CString)"SDL.app.metadata.type";

    public static CString SDL_PROP_APP_METADATA_URL_STRING = (CString)"SDL.app.metadata.url";

    public static CString SDL_PROP_APP_METADATA_VERSION_STRING = (CString)"SDL.app.metadata.version";

    public static CString SDL_PROP_DISPLAY_HDR_ENABLED_BOOLEAN = (CString)"SDL.display.HDR_enabled";

    public static CString SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER = (CString)"SDL.display.KMSDRM.panel_orientation";

    public static CString SDL_PROP_FILE_DIALOG_ACCEPT_STRING = (CString)"SDL.filedialog.accept";

    public static CString SDL_PROP_FILE_DIALOG_CANCEL_STRING = (CString)"SDL.filedialog.cancel";

    public static CString SDL_PROP_FILE_DIALOG_FILTERS_POINTER = (CString)"SDL.filedialog.filters";

    public static CString SDL_PROP_FILE_DIALOG_LOCATION_STRING = (CString)"SDL.filedialog.location";

    public static CString SDL_PROP_FILE_DIALOG_MANY_BOOLEAN = (CString)"SDL.filedialog.many";

    public static CString SDL_PROP_FILE_DIALOG_NFILTERS_NUMBER = (CString)"SDL.filedialog.nfilters";

    public static CString SDL_PROP_FILE_DIALOG_TITLE_STRING = (CString)"SDL.filedialog.title";

    public static CString SDL_PROP_FILE_DIALOG_WINDOW_POINTER = (CString)"SDL.filedialog.window";

    public static CString SDL_PROP_GAMEPAD_CAP_MONO_LED_BOOLEAN = (CString)"SDL.joystick.cap.mono_led";

    public static CString SDL_PROP_GAMEPAD_CAP_PLAYER_LED_BOOLEAN = (CString)"SDL.joystick.cap.player_led";

    public static CString SDL_PROP_GAMEPAD_CAP_RGB_LED_BOOLEAN = (CString)"SDL.joystick.cap.rgb_led";

    public static CString SDL_PROP_GAMEPAD_CAP_RUMBLE_BOOLEAN = (CString)"SDL.joystick.cap.rumble";

    public static CString SDL_PROP_GAMEPAD_CAP_TRIGGER_RUMBLE_BOOLEAN = (CString)"SDL.joystick.cap.trigger_rumble";

    public static CString SDL_PROP_GLOBAL_VIDEO_WAYLAND_WL_DISPLAY_POINTER = (CString)"SDL.video.wayland.wl_display";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_A_FLOAT = (CString)"SDL.gpu.createtexture.d3d12.clear.a";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_B_FLOAT = (CString)"SDL.gpu.createtexture.d3d12.clear.b";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_DEPTH_FLOAT = (CString)"SDL.gpu.createtexture.d3d12.clear.depth";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_G_FLOAT = (CString)"SDL.gpu.createtexture.d3d12.clear.g";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_R_FLOAT = (CString)"SDL.gpu.createtexture.d3d12.clear.r";

    public static CString SDL_PROP_GPU_CREATETEXTURE_D3D12_CLEAR_STENCIL_UINT8 = (CString)"SDL.gpu.createtexture.d3d12.clear.stencil";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_D3D12_SEMANTIC_NAME_STRING = (CString)"SDL.gpu.device.create.d3d12.semantic";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_DEBUGMODE_BOOLEAN = (CString)"SDL.gpu.device.create.debugmode";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_NAME_STRING = (CString)"SDL.gpu.device.create.name";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_PREFERLOWPOWER_BOOLEAN = (CString)"SDL.gpu.device.create.preferlowpower";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_DXBC_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.dxbc";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_DXIL_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.dxil";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_METALLIB_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.metallib";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_MSL_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.msl";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_PRIVATE_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.private";

    public static CString SDL_PROP_GPU_DEVICE_CREATE_SHADERS_SPIRV_BOOLEAN = (CString)"SDL.gpu.device.create.shaders.spirv";

    public static CString SDL_PROP_IOSTREAM_ANDROID_AASSET_POINTER = (CString)"SDL.iostream.android.aasset";

    public static CString SDL_PROP_IOSTREAM_DYNAMIC_CHUNKSIZE_NUMBER = (CString)"SDL.iostream.dynamic.chunksize";

    public static CString SDL_PROP_IOSTREAM_DYNAMIC_MEMORY_POINTER = (CString)"SDL.iostream.dynamic.memory";

    public static CString SDL_PROP_IOSTREAM_FILE_DESCRIPTOR_NUMBER = (CString)"SDL.iostream.file_descriptor";

    public static CString SDL_PROP_IOSTREAM_MEMORY_POINTER = (CString)"SDL.iostream.memory.base";

    public static CString SDL_PROP_IOSTREAM_MEMORY_SIZE_NUMBER = (CString)"SDL.iostream.memory.size";

    public static CString SDL_PROP_IOSTREAM_STDIO_FILE_POINTER = (CString)"SDL.iostream.stdio.file";

    public static CString SDL_PROP_IOSTREAM_WINDOWS_HANDLE_POINTER = (CString)"SDL.iostream.windows.handle";

    public static CString SDL_PROP_JOYSTICK_CAP_MONO_LED_BOOLEAN = (CString)"SDL.joystick.cap.mono_led";

    public static CString SDL_PROP_JOYSTICK_CAP_PLAYER_LED_BOOLEAN = (CString)"SDL.joystick.cap.player_led";

    public static CString SDL_PROP_JOYSTICK_CAP_RGB_LED_BOOLEAN = (CString)"SDL.joystick.cap.rgb_led";

    public static CString SDL_PROP_JOYSTICK_CAP_RUMBLE_BOOLEAN = (CString)"SDL.joystick.cap.rumble";

    public static CString SDL_PROP_JOYSTICK_CAP_TRIGGER_RUMBLE_BOOLEAN = (CString)"SDL.joystick.cap.trigger_rumble";

    public static CString SDL_PROP_PROCESS_BACKGROUND_BOOLEAN = (CString)"SDL.process.background";

    public static CString SDL_PROP_PROCESS_CREATE_ARGS_POINTER = (CString)"SDL.process.create.args";

    public static CString SDL_PROP_PROCESS_CREATE_BACKGROUND_BOOLEAN = (CString)"SDL.process.create.background";

    public static CString SDL_PROP_PROCESS_CREATE_ENVIRONMENT_POINTER = (CString)"SDL.process.create.environment";

    public static CString SDL_PROP_PROCESS_CREATE_STDERR_NUMBER = (CString)"SDL.process.create.stderr_option";

    public static CString SDL_PROP_PROCESS_CREATE_STDERR_POINTER = (CString)"SDL.process.create.stderr_source";

    public static CString SDL_PROP_PROCESS_CREATE_STDERR_TO_STDOUT_BOOLEAN = (CString)"SDL.process.create.stderr_to_stdout";

    public static CString SDL_PROP_PROCESS_CREATE_STDIN_NUMBER = (CString)"SDL.process.create.stdin_option";

    public static CString SDL_PROP_PROCESS_CREATE_STDIN_POINTER = (CString)"SDL.process.create.stdin_source";

    public static CString SDL_PROP_PROCESS_CREATE_STDOUT_NUMBER = (CString)"SDL.process.create.stdout_option";

    public static CString SDL_PROP_PROCESS_CREATE_STDOUT_POINTER = (CString)"SDL.process.create.stdout_source";

    public static CString SDL_PROP_PROCESS_PID_NUMBER = (CString)"SDL.process.pid";

    public static CString SDL_PROP_PROCESS_STDERR_POINTER = (CString)"SDL.process.stderr";

    public static CString SDL_PROP_PROCESS_STDIN_POINTER = (CString)"SDL.process.stdin";

    public static CString SDL_PROP_PROCESS_STDOUT_POINTER = (CString)"SDL.process.stdout";

    public static CString SDL_PROP_RENDERER_CREATE_NAME_STRING = (CString)"SDL.renderer.create.name";

    public static CString SDL_PROP_RENDERER_CREATE_OUTPUT_COLORSPACE_NUMBER = (CString)"SDL.renderer.create.output_colorspace";

    public static CString SDL_PROP_RENDERER_CREATE_PRESENT_VSYNC_NUMBER = (CString)"SDL.renderer.create.present_vsync";

    public static CString SDL_PROP_RENDERER_CREATE_SURFACE_POINTER = (CString)"SDL.renderer.create.surface";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_DEVICE_POINTER = (CString)"SDL.renderer.create.vulkan.device";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_GRAPHICS_QUEUE_FAMILY_INDEX_NUMBER = (CString)"SDL.renderer.create.vulkan.graphics_queue_family_index";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_INSTANCE_POINTER = (CString)"SDL.renderer.create.vulkan.instance";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_PHYSICAL_DEVICE_POINTER = (CString)"SDL.renderer.create.vulkan.physical_device";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_PRESENT_QUEUE_FAMILY_INDEX_NUMBER = (CString)"SDL.renderer.create.vulkan.present_queue_family_index";

    public static CString SDL_PROP_RENDERER_CREATE_VULKAN_SURFACE_NUMBER = (CString)"SDL.renderer.create.vulkan.surface";

    public static CString SDL_PROP_RENDERER_CREATE_WINDOW_POINTER = (CString)"SDL.renderer.create.window";

    public static CString SDL_PROP_RENDERER_D3D11_DEVICE_POINTER = (CString)"SDL.renderer.d3d11.device";

    public static CString SDL_PROP_RENDERER_D3D11_SWAPCHAIN_POINTER = (CString)"SDL.renderer.d3d11.swap_chain";

    public static CString SDL_PROP_RENDERER_D3D12_COMMAND_QUEUE_POINTER = (CString)"SDL.renderer.d3d12.command_queue";

    public static CString SDL_PROP_RENDERER_D3D12_DEVICE_POINTER = (CString)"SDL.renderer.d3d12.device";

    public static CString SDL_PROP_RENDERER_D3D12_SWAPCHAIN_POINTER = (CString)"SDL.renderer.d3d12.swap_chain";

    public static CString SDL_PROP_RENDERER_D3D9_DEVICE_POINTER = (CString)"SDL.renderer.d3d9.device";

    public static CString SDL_PROP_RENDERER_HDR_ENABLED_BOOLEAN = (CString)"SDL.renderer.HDR_enabled";

    public static CString SDL_PROP_RENDERER_HDR_HEADROOM_FLOAT = (CString)"SDL.renderer.HDR_headroom";

    public static CString SDL_PROP_RENDERER_MAX_TEXTURE_SIZE_NUMBER = (CString)"SDL.renderer.max_texture_size";

    public static CString SDL_PROP_RENDERER_NAME_STRING = (CString)"SDL.renderer.name";

    public static CString SDL_PROP_RENDERER_OUTPUT_COLORSPACE_NUMBER = (CString)"SDL.renderer.output_colorspace";

    public static CString SDL_PROP_RENDERER_SDR_WHITE_POINT_FLOAT = (CString)"SDL.renderer.SDR_white_point";

    public static CString SDL_PROP_RENDERER_SURFACE_POINTER = (CString)"SDL.renderer.surface";

    public static CString SDL_PROP_RENDERER_TEXTURE_FORMATS_POINTER = (CString)"SDL.renderer.texture_formats";

    public static CString SDL_PROP_RENDERER_VSYNC_NUMBER = (CString)"SDL.renderer.vsync";

    public static CString SDL_PROP_RENDERER_VULKAN_DEVICE_POINTER = (CString)"SDL.renderer.vulkan.device";

    public static CString SDL_PROP_RENDERER_VULKAN_GRAPHICS_QUEUE_FAMILY_INDEX_NUMBER = (CString)"SDL.renderer.vulkan.graphics_queue_family_index";

    public static CString SDL_PROP_RENDERER_VULKAN_INSTANCE_POINTER = (CString)"SDL.renderer.vulkan.instance";

    public static CString SDL_PROP_RENDERER_VULKAN_PHYSICAL_DEVICE_POINTER = (CString)"SDL.renderer.vulkan.physical_device";

    public static CString SDL_PROP_RENDERER_VULKAN_PRESENT_QUEUE_FAMILY_INDEX_NUMBER = (CString)"SDL.renderer.vulkan.present_queue_family_index";

    public static CString SDL_PROP_RENDERER_VULKAN_SURFACE_NUMBER = (CString)"SDL.renderer.vulkan.surface";

    public static CString SDL_PROP_RENDERER_VULKAN_SWAPCHAIN_IMAGE_COUNT_NUMBER = (CString)"SDL.renderer.vulkan.swapchain_image_count";

    public static CString SDL_PROP_RENDERER_WINDOW_POINTER = (CString)"SDL.renderer.window";

    public static CString SDL_PROP_SURFACE_HDR_HEADROOM_FLOAT = (CString)"SDL.surface.HDR_headroom";

    public static CString SDL_PROP_SURFACE_SDR_WHITE_POINT_FLOAT = (CString)"SDL.surface.SDR_white_point";

    public static CString SDL_PROP_SURFACE_TONEMAP_OPERATOR_STRING = (CString)"SDL.surface.tonemap";

    public static CString SDL_PROP_TEXTINPUT_ANDROID_INPUTTYPE_NUMBER = (CString)"SDL.textinput.android.inputtype";

    public static CString SDL_PROP_TEXTINPUT_AUTOCORRECT_BOOLEAN = (CString)"SDL.textinput.autocorrect";

    public static CString SDL_PROP_TEXTINPUT_CAPITALIZATION_NUMBER = (CString)"SDL.textinput.capitalization";

    public static CString SDL_PROP_TEXTINPUT_MULTILINE_BOOLEAN = (CString)"SDL.textinput.multiline";

    public static CString SDL_PROP_TEXTINPUT_TYPE_NUMBER = (CString)"SDL.textinput.type";

    public static CString SDL_PROP_TEXTURE_ACCESS_NUMBER = (CString)"SDL.texture.access";

    public static CString SDL_PROP_TEXTURE_COLORSPACE_NUMBER = (CString)"SDL.texture.colorspace";

    public static CString SDL_PROP_TEXTURE_CREATE_ACCESS_NUMBER = (CString)"SDL.texture.create.access";

    public static CString SDL_PROP_TEXTURE_CREATE_COLORSPACE_NUMBER = (CString)"SDL.texture.create.colorspace";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D11_TEXTURE_POINTER = (CString)"SDL.texture.create.d3d11.texture";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D11_TEXTURE_U_POINTER = (CString)"SDL.texture.create.d3d11.texture_u";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D11_TEXTURE_V_POINTER = (CString)"SDL.texture.create.d3d11.texture_v";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D12_TEXTURE_POINTER = (CString)"SDL.texture.create.d3d12.texture";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D12_TEXTURE_U_POINTER = (CString)"SDL.texture.create.d3d12.texture_u";

    public static CString SDL_PROP_TEXTURE_CREATE_D3D12_TEXTURE_V_POINTER = (CString)"SDL.texture.create.d3d12.texture_v";

    public static CString SDL_PROP_TEXTURE_CREATE_FORMAT_NUMBER = (CString)"SDL.texture.create.format";

    public static CString SDL_PROP_TEXTURE_CREATE_HDR_HEADROOM_FLOAT = (CString)"SDL.texture.create.HDR_headroom";

    public static CString SDL_PROP_TEXTURE_CREATE_HEIGHT_NUMBER = (CString)"SDL.texture.create.height";

    public static CString SDL_PROP_TEXTURE_CREATE_METAL_PIXELBUFFER_POINTER = (CString)"SDL.texture.create.metal.pixelbuffer";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGL_TEXTURE_NUMBER = (CString)"SDL.texture.create.opengl.texture";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGL_TEXTURE_U_NUMBER = (CString)"SDL.texture.create.opengl.texture_u";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGL_TEXTURE_UV_NUMBER = (CString)"SDL.texture.create.opengl.texture_uv";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGL_TEXTURE_V_NUMBER = (CString)"SDL.texture.create.opengl.texture_v";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGLES2_TEXTURE_NUMBER = (CString)"SDL.texture.create.opengles2.texture";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGLES2_TEXTURE_U_NUMBER = (CString)"SDL.texture.create.opengles2.texture_u";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGLES2_TEXTURE_UV_NUMBER = (CString)"SDL.texture.create.opengles2.texture_uv";

    public static CString SDL_PROP_TEXTURE_CREATE_OPENGLES2_TEXTURE_V_NUMBER = (CString)"SDL.texture.create.opengles2.texture_v";

    public static CString SDL_PROP_TEXTURE_CREATE_SDR_WHITE_POINT_FLOAT = (CString)"SDL.texture.create.SDR_white_point";

    public static CString SDL_PROP_TEXTURE_CREATE_VULKAN_TEXTURE_NUMBER = (CString)"SDL.texture.create.vulkan.texture";

    public static CString SDL_PROP_TEXTURE_CREATE_WIDTH_NUMBER = (CString)"SDL.texture.create.width";

    public static CString SDL_PROP_TEXTURE_D3D11_TEXTURE_POINTER = (CString)"SDL.texture.d3d11.texture";

    public static CString SDL_PROP_TEXTURE_D3D11_TEXTURE_U_POINTER = (CString)"SDL.texture.d3d11.texture_u";

    public static CString SDL_PROP_TEXTURE_D3D11_TEXTURE_V_POINTER = (CString)"SDL.texture.d3d11.texture_v";

    public static CString SDL_PROP_TEXTURE_D3D12_TEXTURE_POINTER = (CString)"SDL.texture.d3d12.texture";

    public static CString SDL_PROP_TEXTURE_D3D12_TEXTURE_U_POINTER = (CString)"SDL.texture.d3d12.texture_u";

    public static CString SDL_PROP_TEXTURE_D3D12_TEXTURE_V_POINTER = (CString)"SDL.texture.d3d12.texture_v";

    public static CString SDL_PROP_TEXTURE_FORMAT_NUMBER = (CString)"SDL.texture.format";

    public static CString SDL_PROP_TEXTURE_HDR_HEADROOM_FLOAT = (CString)"SDL.texture.HDR_headroom";

    public static CString SDL_PROP_TEXTURE_HEIGHT_NUMBER = (CString)"SDL.texture.height";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEX_H_FLOAT = (CString)"SDL.texture.opengl.tex_h";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEX_W_FLOAT = (CString)"SDL.texture.opengl.tex_w";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEXTURE_NUMBER = (CString)"SDL.texture.opengl.texture";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEXTURE_TARGET_NUMBER = (CString)"SDL.texture.opengl.target";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEXTURE_U_NUMBER = (CString)"SDL.texture.opengl.texture_u";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEXTURE_UV_NUMBER = (CString)"SDL.texture.opengl.texture_uv";

    public static CString SDL_PROP_TEXTURE_OPENGL_TEXTURE_V_NUMBER = (CString)"SDL.texture.opengl.texture_v";

    public static CString SDL_PROP_TEXTURE_OPENGLES2_TEXTURE_NUMBER = (CString)"SDL.texture.opengles2.texture";

    public static CString SDL_PROP_TEXTURE_OPENGLES2_TEXTURE_TARGET_NUMBER = (CString)"SDL.texture.opengles2.target";

    public static CString SDL_PROP_TEXTURE_OPENGLES2_TEXTURE_U_NUMBER = (CString)"SDL.texture.opengles2.texture_u";

    public static CString SDL_PROP_TEXTURE_OPENGLES2_TEXTURE_UV_NUMBER = (CString)"SDL.texture.opengles2.texture_uv";

    public static CString SDL_PROP_TEXTURE_OPENGLES2_TEXTURE_V_NUMBER = (CString)"SDL.texture.opengles2.texture_v";

    public static CString SDL_PROP_TEXTURE_SDR_WHITE_POINT_FLOAT = (CString)"SDL.texture.SDR_white_point";

    public static CString SDL_PROP_TEXTURE_VULKAN_TEXTURE_NUMBER = (CString)"SDL.texture.vulkan.texture";

    public static CString SDL_PROP_TEXTURE_WIDTH_NUMBER = (CString)"SDL.texture.width";

    public static CString SDL_PROP_WINDOW_ANDROID_SURFACE_POINTER = (CString)"SDL.window.android.surface";

    public static CString SDL_PROP_WINDOW_ANDROID_WINDOW_POINTER = (CString)"SDL.window.android.window";

    public static CString SDL_PROP_WINDOW_COCOA_METAL_VIEW_TAG_NUMBER = (CString)"SDL.window.cocoa.metal_view_tag";

    public static CString SDL_PROP_WINDOW_COCOA_WINDOW_POINTER = (CString)"SDL.window.cocoa.window";

    public static CString SDL_PROP_WINDOW_CREATE_ALWAYS_ON_TOP_BOOLEAN = (CString)"SDL.window.create.always_on_top";

    public static CString SDL_PROP_WINDOW_CREATE_BORDERLESS_BOOLEAN = (CString)"SDL.window.create.borderless";

    public static CString SDL_PROP_WINDOW_CREATE_COCOA_VIEW_POINTER = (CString)"SDL.window.create.cocoa.view";

    public static CString SDL_PROP_WINDOW_CREATE_COCOA_WINDOW_POINTER = (CString)"SDL.window.create.cocoa.window";

    public static CString SDL_PROP_WINDOW_CREATE_EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN = (CString)"SDL.window.create.external_graphics_context";

    public static CString SDL_PROP_WINDOW_CREATE_FLAGS_NUMBER = (CString)"SDL.window.create.flags";

    public static CString SDL_PROP_WINDOW_CREATE_FOCUSABLE_BOOLEAN = (CString)"SDL.window.create.focusable";

    public static CString SDL_PROP_WINDOW_CREATE_FULLSCREEN_BOOLEAN = (CString)"SDL.window.create.fullscreen";

    public static CString SDL_PROP_WINDOW_CREATE_HEIGHT_NUMBER = (CString)"SDL.window.create.height";

    public static CString SDL_PROP_WINDOW_CREATE_HIDDEN_BOOLEAN = (CString)"SDL.window.create.hidden";

    public static CString SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN = (CString)"SDL.window.create.high_pixel_density";

    public static CString SDL_PROP_WINDOW_CREATE_MAXIMIZED_BOOLEAN = (CString)"SDL.window.create.maximized";

    public static CString SDL_PROP_WINDOW_CREATE_MENU_BOOLEAN = (CString)"SDL.window.create.menu";

    public static CString SDL_PROP_WINDOW_CREATE_METAL_BOOLEAN = (CString)"SDL.window.create.metal";

    public static CString SDL_PROP_WINDOW_CREATE_MINIMIZED_BOOLEAN = (CString)"SDL.window.create.minimized";

    public static CString SDL_PROP_WINDOW_CREATE_MODAL_BOOLEAN = (CString)"SDL.window.create.modal";

    public static CString SDL_PROP_WINDOW_CREATE_MOUSE_GRABBED_BOOLEAN = (CString)"SDL.window.create.mouse_grabbed";

    public static CString SDL_PROP_WINDOW_CREATE_OPENGL_BOOLEAN = (CString)"SDL.window.create.opengl";

    public static CString SDL_PROP_WINDOW_CREATE_PARENT_POINTER = (CString)"SDL.window.create.parent";

    public static CString SDL_PROP_WINDOW_CREATE_RESIZABLE_BOOLEAN = (CString)"SDL.window.create.resizable";

    public static CString SDL_PROP_WINDOW_CREATE_TITLE_STRING = (CString)"SDL.window.create.title";

    public static CString SDL_PROP_WINDOW_CREATE_TOOLTIP_BOOLEAN = (CString)"SDL.window.create.tooltip";

    public static CString SDL_PROP_WINDOW_CREATE_TRANSPARENT_BOOLEAN = (CString)"SDL.window.create.transparent";

    public static CString SDL_PROP_WINDOW_CREATE_UTILITY_BOOLEAN = (CString)"SDL.window.create.utility";

    public static CString SDL_PROP_WINDOW_CREATE_VULKAN_BOOLEAN = (CString)"SDL.window.create.vulkan";

    public static CString SDL_PROP_WINDOW_CREATE_WAYLAND_CREATE_EGL_WINDOW_BOOLEAN = (CString)"SDL.window.create.wayland.create_egl_window";

    public static CString SDL_PROP_WINDOW_CREATE_WAYLAND_SURFACE_ROLE_CUSTOM_BOOLEAN = (CString)"SDL.window.create.wayland.surface_role_custom";

    public static CString SDL_PROP_WINDOW_CREATE_WAYLAND_WL_SURFACE_POINTER = (CString)"SDL.window.create.wayland.wl_surface";

    public static CString SDL_PROP_WINDOW_CREATE_WIDTH_NUMBER = (CString)"SDL.window.create.width";

    public static CString SDL_PROP_WINDOW_CREATE_WIN32_HWND_POINTER = (CString)"SDL.window.create.win32.hwnd";

    public static CString SDL_PROP_WINDOW_CREATE_WIN32_PIXEL_FORMAT_HWND_POINTER = (CString)"SDL.window.create.win32.pixel_format_hwnd";

    public static CString SDL_PROP_WINDOW_CREATE_X_NUMBER = (CString)"SDL.window.create.x";

    public static CString SDL_PROP_WINDOW_CREATE_X11_WINDOW_NUMBER = (CString)"SDL.window.create.x11.window";

    public static CString SDL_PROP_WINDOW_CREATE_Y_NUMBER = (CString)"SDL.window.create.y";

    public static CString SDL_PROP_WINDOW_HDR_ENABLED_BOOLEAN = (CString)"SDL.window.HDR_enabled";

    public static CString SDL_PROP_WINDOW_HDR_HEADROOM_FLOAT = (CString)"SDL.window.HDR_headroom";

    public static CString SDL_PROP_WINDOW_KMSDRM_DEVICE_INDEX_NUMBER = (CString)"SDL.window.kmsdrm.dev_index";

    public static CString SDL_PROP_WINDOW_KMSDRM_DRM_FD_NUMBER = (CString)"SDL.window.kmsdrm.drm_fd";

    public static CString SDL_PROP_WINDOW_KMSDRM_GBM_DEVICE_POINTER = (CString)"SDL.window.kmsdrm.gbm_dev";

    public static CString SDL_PROP_WINDOW_OPENVR_OVERLAY_ID = (CString)"SDL.window.openvr.overlay_id";

    public static CString SDL_PROP_WINDOW_SDR_WHITE_LEVEL_FLOAT = (CString)"SDL.window.SDR_white_level";

    public static CString SDL_PROP_WINDOW_SHAPE_POINTER = (CString)"SDL.window.shape";

    public static CString SDL_PROP_WINDOW_UIKIT_METAL_VIEW_TAG_NUMBER = (CString)"SDL.window.uikit.metal_view_tag";

    public static CString SDL_PROP_WINDOW_UIKIT_OPENGL_FRAMEBUFFER_NUMBER = (CString)"SDL.window.uikit.opengl.framebuffer";

    public static CString SDL_PROP_WINDOW_UIKIT_OPENGL_RENDERBUFFER_NUMBER = (CString)"SDL.window.uikit.opengl.renderbuffer";

    public static CString SDL_PROP_WINDOW_UIKIT_OPENGL_RESOLVE_FRAMEBUFFER_NUMBER = (CString)"SDL.window.uikit.opengl.resolve_framebuffer";

    public static CString SDL_PROP_WINDOW_UIKIT_WINDOW_POINTER = (CString)"SDL.window.uikit.window";

    public static CString SDL_PROP_WINDOW_VIVANTE_DISPLAY_POINTER = (CString)"SDL.window.vivante.display";

    public static CString SDL_PROP_WINDOW_VIVANTE_SURFACE_POINTER = (CString)"SDL.window.vivante.surface";

    public static CString SDL_PROP_WINDOW_VIVANTE_WINDOW_POINTER = (CString)"SDL.window.vivante.window";

    public static CString SDL_PROP_WINDOW_WAYLAND_DISPLAY_POINTER = (CString)"SDL.window.wayland.display";

    public static CString SDL_PROP_WINDOW_WAYLAND_EGL_WINDOW_POINTER = (CString)"SDL.window.wayland.egl_window";

    public static CString SDL_PROP_WINDOW_WAYLAND_SURFACE_POINTER = (CString)"SDL.window.wayland.surface";

    public static CString SDL_PROP_WINDOW_WAYLAND_VIEWPORT_POINTER = (CString)"SDL.window.wayland.viewport";

    public static CString SDL_PROP_WINDOW_WAYLAND_XDG_POPUP_POINTER = (CString)"SDL.window.wayland.xdg_popup";

    public static CString SDL_PROP_WINDOW_WAYLAND_XDG_POSITIONER_POINTER = (CString)"SDL.window.wayland.xdg_positioner";

    public static CString SDL_PROP_WINDOW_WAYLAND_XDG_SURFACE_POINTER = (CString)"SDL.window.wayland.xdg_surface";

    public static CString SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING = (CString)"SDL.window.wayland.xdg_toplevel_export_handle";

    public static CString SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_POINTER = (CString)"SDL.window.wayland.xdg_toplevel";

    public static CString SDL_PROP_WINDOW_WIN32_HDC_POINTER = (CString)"SDL.window.win32.hdc";

    public static CString SDL_PROP_WINDOW_WIN32_HWND_POINTER = (CString)"SDL.window.win32.hwnd";

    public static CString SDL_PROP_WINDOW_WIN32_INSTANCE_POINTER = (CString)"SDL.window.win32.instance";

    public static CString SDL_PROP_WINDOW_X11_DISPLAY_POINTER = (CString)"SDL.window.x11.display";

    public static CString SDL_PROP_WINDOW_X11_SCREEN_NUMBER = (CString)"SDL.window.x11.screen";

    public static CString SDL_PROP_WINDOW_X11_WINDOW_NUMBER = (CString)"SDL.window.x11.window";

    public static int SDL_RENDERER_VSYNC_ADAPTIVE = (int)-1;

    public static int SDL_RENDERER_VSYNC_DISABLED = (int)0;

    public static CString SDL_SOFTWARE_RENDERER = (CString)"software";

    public static float SDL_STANDARD_GRAVITY = (float)9.806650161743164;

    public static uint SDL_SURFACE_LOCK_NEEDED = (uint)2;

    public static uint SDL_SURFACE_LOCKED = (uint)4;

    public static uint SDL_SURFACE_PREALLOCATED = (uint)1;

    public static uint SDL_SURFACE_SIMD_ALIGNED = (uint)8;

    public static SDL_MouseID SDL_TOUCH_MOUSEID = (SDL_MouseID)4294967295;

    public static int SDL_VERSION = (int)3001007;

    public static ulong SDL_WINDOW_ALWAYS_ON_TOP = (ulong)65536;

    public static ulong SDL_WINDOW_BORDERLESS = (ulong)16;

    public static ulong SDL_WINDOW_EXTERNAL = (ulong)2048;

    public static ulong SDL_WINDOW_FULLSCREEN = (ulong)1;

    public static ulong SDL_WINDOW_HIDDEN = (ulong)8;

    public static ulong SDL_WINDOW_HIGH_PIXEL_DENSITY = (ulong)8192;

    public static ulong SDL_WINDOW_INPUT_FOCUS = (ulong)512;

    public static ulong SDL_WINDOW_KEYBOARD_GRABBED = (ulong)1048576;

    public static ulong SDL_WINDOW_MAXIMIZED = (ulong)128;

    public static ulong SDL_WINDOW_METAL = (ulong)536870912;

    public static ulong SDL_WINDOW_MINIMIZED = (ulong)64;

    public static ulong SDL_WINDOW_MODAL = (ulong)4096;

    public static ulong SDL_WINDOW_MOUSE_CAPTURE = (ulong)16384;

    public static ulong SDL_WINDOW_MOUSE_FOCUS = (ulong)1024;

    public static ulong SDL_WINDOW_MOUSE_GRABBED = (ulong)256;

    public static ulong SDL_WINDOW_MOUSE_RELATIVE_MODE = (ulong)32768;

    public static ulong SDL_WINDOW_NOT_FOCUSABLE = (ulong)2147483648;

    public static ulong SDL_WINDOW_OCCLUDED = (ulong)4;

    public static ulong SDL_WINDOW_OPENGL = (ulong)2;

    public static ulong SDL_WINDOW_POPUP_MENU = (ulong)524288;

    public static ulong SDL_WINDOW_RESIZABLE = (ulong)32;

    public static int SDL_WINDOW_SURFACE_VSYNC_ADAPTIVE = (int)-1;

    public static int SDL_WINDOW_SURFACE_VSYNC_DISABLED = (int)0;

    public static ulong SDL_WINDOW_TOOLTIP = (ulong)262144;

    public static ulong SDL_WINDOW_TRANSPARENT = (ulong)1073741824;

    public static ulong SDL_WINDOW_UTILITY = (ulong)131072;

    public static ulong SDL_WINDOW_VULKAN = (ulong)268435456;

    public static uint SDL_WINDOWPOS_CENTERED = (uint)805240832;

    public static uint SDL_WINDOWPOS_CENTERED_MASK = (uint)805240832;

    public static uint SDL_WINDOWPOS_UNDEFINED = (uint)536805376;

    public static uint SDL_WINDOWPOS_UNDEFINED_MASK = (uint)536805376;

    public static uint SDLK_0 = (uint)48;

    public static uint SDLK_1 = (uint)49;

    public static uint SDLK_2 = (uint)50;

    public static uint SDLK_3 = (uint)51;

    public static uint SDLK_4 = (uint)52;

    public static uint SDLK_5 = (uint)53;

    public static uint SDLK_6 = (uint)54;

    public static uint SDLK_7 = (uint)55;

    public static uint SDLK_8 = (uint)56;

    public static uint SDLK_9 = (uint)57;

    public static uint SDLK_A = (uint)97;

    public static uint SDLK_AC_BACK = (uint)1073742106;

    public static uint SDLK_AC_BOOKMARKS = (uint)1073742110;

    public static uint SDLK_AC_CLOSE = (uint)1073742099;

    public static uint SDLK_AC_EXIT = (uint)1073742100;

    public static uint SDLK_AC_FORWARD = (uint)1073742107;

    public static uint SDLK_AC_HOME = (uint)1073742105;

    public static uint SDLK_AC_NEW = (uint)1073742097;

    public static uint SDLK_AC_OPEN = (uint)1073742098;

    public static uint SDLK_AC_PRINT = (uint)1073742102;

    public static uint SDLK_AC_PROPERTIES = (uint)1073742103;

    public static uint SDLK_AC_REFRESH = (uint)1073742109;

    public static uint SDLK_AC_SAVE = (uint)1073742101;

    public static uint SDLK_AC_SEARCH = (uint)1073742104;

    public static uint SDLK_AC_STOP = (uint)1073742108;

    public static uint SDLK_AGAIN = (uint)1073741945;

    public static uint SDLK_ALTERASE = (uint)1073741977;

    public static uint SDLK_AMPERSAND = (uint)38;

    public static uint SDLK_APOSTROPHE = (uint)39;

    public static uint SDLK_APPLICATION = (uint)1073741925;

    public static uint SDLK_ASTERISK = (uint)42;

    public static uint SDLK_AT = (uint)64;

    public static uint SDLK_B = (uint)98;

    public static uint SDLK_BACKSLASH = (uint)92;

    public static uint SDLK_BACKSPACE = (uint)8;

    public static uint SDLK_C = (uint)99;

    public static uint SDLK_CALL = (uint)1073742113;

    public static uint SDLK_CANCEL = (uint)1073741979;

    public static uint SDLK_CAPSLOCK = (uint)1073741881;

    public static uint SDLK_CARET = (uint)94;

    public static uint SDLK_CHANNEL_DECREMENT = (uint)1073742085;

    public static uint SDLK_CHANNEL_INCREMENT = (uint)1073742084;

    public static uint SDLK_CLEAR = (uint)1073741980;

    public static uint SDLK_CLEARAGAIN = (uint)1073741986;

    public static uint SDLK_COLON = (uint)58;

    public static uint SDLK_COMMA = (uint)44;

    public static uint SDLK_COPY = (uint)1073741948;

    public static uint SDLK_CRSEL = (uint)1073741987;

    public static uint SDLK_CURRENCYSUBUNIT = (uint)1073742005;

    public static uint SDLK_CURRENCYUNIT = (uint)1073742004;

    public static uint SDLK_CUT = (uint)1073741947;

    public static uint SDLK_D = (uint)100;

    public static uint SDLK_DBLAPOSTROPHE = (uint)34;

    public static uint SDLK_DECIMALSEPARATOR = (uint)1073742003;

    public static uint SDLK_DELETE = (uint)127;

    public static uint SDLK_DOLLAR = (uint)36;

    public static uint SDLK_DOWN = (uint)1073741905;

    public static uint SDLK_E = (uint)101;

    public static uint SDLK_END = (uint)1073741901;

    public static uint SDLK_ENDCALL = (uint)1073742114;

    public static uint SDLK_EQUALS = (uint)61;

    public static uint SDLK_ESCAPE = (uint)27;

    public static uint SDLK_EXCLAIM = (uint)33;

    public static uint SDLK_EXECUTE = (uint)1073741940;

    public static uint SDLK_EXSEL = (uint)1073741988;

    public static uint SDLK_F = (uint)102;

    public static uint SDLK_F1 = (uint)1073741882;

    public static uint SDLK_F10 = (uint)1073741891;

    public static uint SDLK_F11 = (uint)1073741892;

    public static uint SDLK_F12 = (uint)1073741893;

    public static uint SDLK_F13 = (uint)1073741928;

    public static uint SDLK_F14 = (uint)1073741929;

    public static uint SDLK_F15 = (uint)1073741930;

    public static uint SDLK_F16 = (uint)1073741931;

    public static uint SDLK_F17 = (uint)1073741932;

    public static uint SDLK_F18 = (uint)1073741933;

    public static uint SDLK_F19 = (uint)1073741934;

    public static uint SDLK_F2 = (uint)1073741883;

    public static uint SDLK_F20 = (uint)1073741935;

    public static uint SDLK_F21 = (uint)1073741936;

    public static uint SDLK_F22 = (uint)1073741937;

    public static uint SDLK_F23 = (uint)1073741938;

    public static uint SDLK_F24 = (uint)1073741939;

    public static uint SDLK_F3 = (uint)1073741884;

    public static uint SDLK_F4 = (uint)1073741885;

    public static uint SDLK_F5 = (uint)1073741886;

    public static uint SDLK_F6 = (uint)1073741887;

    public static uint SDLK_F7 = (uint)1073741888;

    public static uint SDLK_F8 = (uint)1073741889;

    public static uint SDLK_F9 = (uint)1073741890;

    public static uint SDLK_FIND = (uint)1073741950;

    public static uint SDLK_G = (uint)103;

    public static uint SDLK_GRAVE = (uint)96;

    public static uint SDLK_GREATER = (uint)62;

    public static uint SDLK_HASH = (uint)35;

    public static uint SDLK_HELP = (uint)1073741941;

    public static uint SDLK_HOME = (uint)1073741898;

    public static uint SDLK_I = (uint)105;

    public static uint SDLK_INSERT = (uint)1073741897;

    public static uint SDLK_J = (uint)106;

    public static uint SDLK_K = (uint)107;

    public static uint SDLK_KP_0 = (uint)1073741922;

    public static uint SDLK_KP_00 = (uint)1073742000;

    public static uint SDLK_KP_000 = (uint)1073742001;

    public static uint SDLK_KP_1 = (uint)1073741913;

    public static uint SDLK_KP_2 = (uint)1073741914;

    public static uint SDLK_KP_3 = (uint)1073741915;

    public static uint SDLK_KP_4 = (uint)1073741916;

    public static uint SDLK_KP_5 = (uint)1073741917;

    public static uint SDLK_KP_6 = (uint)1073741918;

    public static uint SDLK_KP_7 = (uint)1073741919;

    public static uint SDLK_KP_8 = (uint)1073741920;

    public static uint SDLK_KP_9 = (uint)1073741921;

    public static uint SDLK_KP_A = (uint)1073742012;

    public static uint SDLK_KP_AMPERSAND = (uint)1073742023;

    public static uint SDLK_KP_AT = (uint)1073742030;

    public static uint SDLK_KP_B = (uint)1073742013;

    public static uint SDLK_KP_BACKSPACE = (uint)1073742011;

    public static uint SDLK_KP_BINARY = (uint)1073742042;

    public static uint SDLK_KP_C = (uint)1073742014;

    public static uint SDLK_KP_CLEAR = (uint)1073742040;

    public static uint SDLK_KP_CLEARENTRY = (uint)1073742041;

    public static uint SDLK_KP_COLON = (uint)1073742027;

    public static uint SDLK_KP_COMMA = (uint)1073741957;

    public static uint SDLK_KP_D = (uint)1073742015;

    public static uint SDLK_KP_DBLAMPERSAND = (uint)1073742024;

    public static uint SDLK_KP_DBLVERTICALBAR = (uint)1073742026;

    public static uint SDLK_KP_DECIMAL = (uint)1073742044;

    public static uint SDLK_KP_DIVIDE = (uint)1073741908;

    public static uint SDLK_KP_E = (uint)1073742016;

    public static uint SDLK_KP_ENTER = (uint)1073741912;

    public static uint SDLK_KP_EQUALS = (uint)1073741927;

    public static uint SDLK_KP_EQUALSAS400 = (uint)1073741958;

    public static uint SDLK_KP_EXCLAM = (uint)1073742031;

    public static uint SDLK_KP_F = (uint)1073742017;

    public static uint SDLK_KP_GREATER = (uint)1073742022;

    public static uint SDLK_KP_HASH = (uint)1073742028;

    public static uint SDLK_KP_HEXADECIMAL = (uint)1073742045;

    public static uint SDLK_KP_LEFTBRACE = (uint)1073742008;

    public static uint SDLK_KP_LEFTPAREN = (uint)1073742006;

    public static uint SDLK_KP_LESS = (uint)1073742021;

    public static uint SDLK_KP_MEMADD = (uint)1073742035;

    public static uint SDLK_KP_MEMCLEAR = (uint)1073742034;

    public static uint SDLK_KP_MEMDIVIDE = (uint)1073742038;

    public static uint SDLK_KP_MEMMULTIPLY = (uint)1073742037;

    public static uint SDLK_KP_MEMRECALL = (uint)1073742033;

    public static uint SDLK_KP_MEMSTORE = (uint)1073742032;

    public static uint SDLK_KP_MEMSUBTRACT = (uint)1073742036;

    public static uint SDLK_KP_MINUS = (uint)1073741910;

    public static uint SDLK_KP_MULTIPLY = (uint)1073741909;

    public static uint SDLK_KP_OCTAL = (uint)1073742043;

    public static uint SDLK_KP_PERCENT = (uint)1073742020;

    public static uint SDLK_KP_PERIOD = (uint)1073741923;

    public static uint SDLK_KP_PLUS = (uint)1073741911;

    public static uint SDLK_KP_PLUSMINUS = (uint)1073742039;

    public static uint SDLK_KP_POWER = (uint)1073742019;

    public static uint SDLK_KP_RIGHTBRACE = (uint)1073742009;

    public static uint SDLK_KP_RIGHTPAREN = (uint)1073742007;

    public static uint SDLK_KP_SPACE = (uint)1073742029;

    public static uint SDLK_KP_TAB = (uint)1073742010;

    public static uint SDLK_KP_VERTICALBAR = (uint)1073742025;

    public static uint SDLK_KP_XOR = (uint)1073742018;

    public static uint SDLK_L = (uint)108;

    public static uint SDLK_LALT = (uint)1073742050;

    public static uint SDLK_LCTRL = (uint)1073742048;

    public static uint SDLK_LEFT = (uint)1073741904;

    public static uint SDLK_LEFTBRACE = (uint)123;

    public static uint SDLK_LEFTBRACKET = (uint)91;

    public static uint SDLK_LEFTPAREN = (uint)40;

    public static uint SDLK_LESS = (uint)60;

    public static uint SDLK_LGUI = (uint)1073742051;

    public static uint SDLK_LSHIFT = (uint)1073742049;

    public static uint SDLK_M = (uint)109;

    public static uint SDLK_MEDIA_EJECT = (uint)1073742094;

    public static uint SDLK_MEDIA_FAST_FORWARD = (uint)1073742089;

    public static uint SDLK_MEDIA_NEXT_TRACK = (uint)1073742091;

    public static uint SDLK_MEDIA_PAUSE = (uint)1073742087;

    public static uint SDLK_MEDIA_PLAY = (uint)1073742086;

    public static uint SDLK_MEDIA_PLAY_PAUSE = (uint)1073742095;

    public static uint SDLK_MEDIA_PREVIOUS_TRACK = (uint)1073742092;

    public static uint SDLK_MEDIA_RECORD = (uint)1073742088;

    public static uint SDLK_MEDIA_REWIND = (uint)1073742090;

    public static uint SDLK_MEDIA_SELECT = (uint)1073742096;

    public static uint SDLK_MEDIA_STOP = (uint)1073742093;

    public static uint SDLK_MENU = (uint)1073741942;

    public static uint SDLK_MINUS = (uint)45;

    public static uint SDLK_MODE = (uint)1073742081;

    public static uint SDLK_MUTE = (uint)1073741951;

    public static uint SDLK_N = (uint)110;

    public static uint SDLK_NUMLOCKCLEAR = (uint)1073741907;

    public static uint SDLK_O = (uint)111;

    public static uint SDLK_OPER = (uint)1073741985;

    public static uint SDLK_OUT = (uint)1073741984;

    public static uint SDLK_P = (uint)112;

    public static uint SDLK_PAGEDOWN = (uint)1073741902;

    public static uint SDLK_PAGEUP = (uint)1073741899;

    public static uint SDLK_PASTE = (uint)1073741949;

    public static uint SDLK_PAUSE = (uint)1073741896;

    public static uint SDLK_PERCENT = (uint)37;

    public static uint SDLK_PERIOD = (uint)46;

    public static uint SDLK_PIPE = (uint)124;

    public static uint SDLK_PLUS = (uint)43;

    public static uint SDLK_PLUSMINUS = (uint)177;

    public static uint SDLK_POWER = (uint)1073741926;

    public static uint SDLK_PRINTSCREEN = (uint)1073741894;

    public static uint SDLK_PRIOR = (uint)1073741981;

    public static uint SDLK_Q = (uint)113;

    public static uint SDLK_QUESTION = (uint)63;

    public static uint SDLK_R = (uint)114;

    public static uint SDLK_RALT = (uint)1073742054;

    public static uint SDLK_RCTRL = (uint)1073742052;

    public static uint SDLK_RETURN = (uint)13;

    public static uint SDLK_RETURN2 = (uint)1073741982;

    public static uint SDLK_RGUI = (uint)1073742055;

    public static uint SDLK_RIGHT = (uint)1073741903;

    public static uint SDLK_RIGHTBRACE = (uint)125;

    public static uint SDLK_RIGHTBRACKET = (uint)93;

    public static uint SDLK_RIGHTPAREN = (uint)41;

    public static uint SDLK_RSHIFT = (uint)1073742053;

    public static uint SDLK_S = (uint)115;

    public static uint SDLK_SCROLLLOCK = (uint)1073741895;

    public static uint SDLK_SELECT = (uint)1073741943;

    public static uint SDLK_SEMICOLON = (uint)59;

    public static uint SDLK_SEPARATOR = (uint)1073741983;

    public static uint SDLK_SLASH = (uint)47;

    public static uint SDLK_SLEEP = (uint)1073742082;

    public static uint SDLK_SOFTLEFT = (uint)1073742111;

    public static uint SDLK_SOFTRIGHT = (uint)1073742112;

    public static uint SDLK_SPACE = (uint)32;

    public static uint SDLK_STOP = (uint)1073741944;

    public static uint SDLK_SYSREQ = (uint)1073741978;

    public static uint SDLK_T = (uint)116;

    public static uint SDLK_TAB = (uint)9;

    public static uint SDLK_THOUSANDSSEPARATOR = (uint)1073742002;

    public static uint SDLK_TILDE = (uint)126;

    public static uint SDLK_U = (uint)117;

    public static uint SDLK_UNDERSCORE = (uint)95;

    public static uint SDLK_UNDO = (uint)1073741946;

    public static uint SDLK_UNKNOWN = (uint)0;

    public static uint SDLK_UP = (uint)1073741906;

    public static uint SDLK_V = (uint)118;

    public static uint SDLK_VOLUMEDOWN = (uint)1073741953;

    public static uint SDLK_VOLUMEUP = (uint)1073741952;

    public static uint SDLK_W = (uint)119;

    public static uint SDLK_WAKE = (uint)1073742083;

    public static uint SDLK_X = (uint)120;

    public static uint SDLK_Y = (uint)121;

    public static uint SDLK_Z = (uint)122;
    ...
    public struct SDL_ClipboardEvent
    {
        ...
        [FieldOffset(20)]
        public int n_mime_types; // size = 4
    ...
    public struct SDL_GamepadBinding
    {
        ...
        [FieldOffset(4)]
        public SDL_GamepadBinding_ANONYMOUS_1 input; // size = 12

        [FieldOffset(16)]
        public SDL_GamepadBindingType output_type; // size = 4

        [FieldOffset(20)]
        public SDL_GamepadBinding_ANONYMOUS_3 output; // size = 12
    }
    ...
    public struct SDL_GamepadBinding_ANONYMOUS_1
    {
        ...
        [FieldOffset(0)]
        public SDL_GamepadBinding_ANONYMOUS_1_ANONYMOUS_1 axis; // size = 12

        [FieldOffset(0)]
        public SDL_GamepadBinding_ANONYMOUS_1_ANONYMOUS_2 hat; // size = 8
    }
    ...
    public struct SDL_GamepadBinding_ANONYMOUS_3
    {
        ...
        [FieldOffset(0)]
        public SDL_GamepadBinding_ANONYMOUS_3_ANONYMOUS_1 axis; // size = 12
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_SDLEGLAttribPtr Data;

        public static implicit operator FnPtr_VoidPtr_SDLEGLAttribPtr(SDL_EGLAttribArrayCallback data) => data.Data;
        public static implicit operator SDL_EGLAttribArrayCallback(FnPtr_VoidPtr_SDLEGLAttribPtr data) => new SDL_EGLAttribArrayCallback() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_SDLEGLDisplay_SDLEGLConfig_SDLEGLintPtr Data;

        public static implicit operator FnPtr_VoidPtr_SDLEGLDisplay_SDLEGLConfig_SDLEGLintPtr(SDL_EGLIntArrayCallback data) => data.Data;
        public static implicit operator SDL_EGLIntArrayCallback(FnPtr_VoidPtr_SDLEGLDisplay_SDLEGLConfig_SDLEGLintPtr data) => new SDL_EGLIntArrayCallback() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_CString_CString_SDLEnumerationResult Data;

        public static implicit operator FnPtr_VoidPtr_CString_CString_SDLEnumerationResult(SDL_EnumerateDirectoryCallback data) => data.Data;
        public static implicit operator SDL_EnumerateDirectoryCallback(FnPtr_VoidPtr_CString_CString_SDLEnumerationResult data) => new SDL_EnumerateDirectoryCallback() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_SDLEventPtr_CBool Data;

        public static implicit operator FnPtr_VoidPtr_SDLEventPtr_CBool(SDL_EventFilter data) => data.Data;
        public static implicit operator SDL_EventFilter(FnPtr_VoidPtr_SDLEventPtr_CBool data) => new SDL_EventFilter() { Data = data };
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
    public struct SDL_GPUBufferUsageFlags
    {
        [FieldOffset(0)]
        public uint Data;
    ...
    public struct SDL_GPUColorComponentFlags
    {
        [FieldOffset(0)]
        public byte Data;
    ...
    [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
    public struct SDL_GPUShaderFormat
    {
        [FieldOffset(0)]
        public uint Data;
    ...
    [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
    public struct SDL_GPUTextureUsageFlags
    {
        [FieldOffset(0)]
        public uint Data;
    ...
    [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
    public struct SDL_MainThreadCallback
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_Void Data;

        public static implicit operator FnPtr_VoidPtr_Void(SDL_MainThreadCallback data) => data.Data;
        public static implicit operator SDL_MainThreadCallback(FnPtr_VoidPtr_Void data) => new SDL_MainThreadCallback() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_SDLTimerID_Ulong_Ulong Data;

        public static implicit operator FnPtr_VoidPtr_SDLTimerID_Ulong_Ulong(SDL_NSTimerCallback data) => data.Data;
        public static implicit operator SDL_NSTimerCallback(FnPtr_VoidPtr_SDLTimerID_Ulong_Ulong data) => new SDL_NSTimerCallback() { Data = data };
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
    public struct SDL_PenInputFlags
    {
        [FieldOffset(0)]
        public uint Data;
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_SDLTimerID_Uint_Uint Data;

        public static implicit operator FnPtr_VoidPtr_SDLTimerID_Uint_Uint(SDL_TimerCallback data) => data.Data;
        public static implicit operator SDL_TimerCallback(FnPtr_VoidPtr_SDLTimerID_Uint_Uint data) => new SDL_TimerCallback() { Data = data };
    }
...
[StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CBool_CBool
    {
        public delegate* unmanaged<void*, CBool, CBool> Pointer;

        public FnPtr_VoidPtr_CBool_CBool(delegate* unmanaged<void*, CBool, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_CString_CBool
    {
        public delegate* unmanaged<void*, CString, CString, CBool> Pointer;

        public FnPtr_VoidPtr_CString_CString_CBool(delegate* unmanaged<void*, CString, CString, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_VoidPtr_Ulong_CBool
    {
        public delegate* unmanaged<void*, CString, void*, ulong, CBool> Pointer;

        public FnPtr_VoidPtr_CString_VoidPtr_Ulong_CBool(delegate* unmanaged<void*, CString, void*, ulong, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_SDLEnumerateDirectoryCallback_VoidPtr_CBool
    {
        public delegate* unmanaged<void*, CString, SDL_EnumerateDirectoryCallback, void*, CBool> Pointer;

        public FnPtr_VoidPtr_CString_SDLEnumerateDirectoryCallback_VoidPtr_CBool(delegate* unmanaged<void*, CString, SDL_EnumerateDirectoryCallback, void*, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_SDLPathInfoPtr_CBool
    {
        public delegate* unmanaged<void*, CString, SDL_PathInfo*, CBool> Pointer;

        public FnPtr_VoidPtr_CString_SDLPathInfoPtr_CBool(delegate* unmanaged<void*, CString, SDL_PathInfo*, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_CBool
    {
        public delegate* unmanaged<void*, CString, CBool> Pointer;

        public FnPtr_VoidPtr_CString_CBool(delegate* unmanaged<void*, CString, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_VoidPtr_Int_CBool
    {
        public delegate* unmanaged<void*, void*, int, CBool> Pointer;

        public FnPtr_VoidPtr_VoidPtr_Int_CBool(delegate* unmanaged<void*, void*, int, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLEventPtr_CBool
    {
        public delegate* unmanaged<void*, SDL_Event*, CBool> Pointer;

        public FnPtr_VoidPtr_SDLEventPtr_CBool(delegate* unmanaged<void*, SDL_Event*, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLIOStatusPtr_CBool
    {
        public delegate* unmanaged<void*, SDL_IOStatus*, CBool> Pointer;

        public FnPtr_VoidPtr_SDLIOStatusPtr_CBool(delegate* unmanaged<void*, SDL_IOStatus*, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_Ushort_Ushort_CBool
    {
        public delegate* unmanaged<void*, ushort, ushort, CBool> Pointer;

        public FnPtr_VoidPtr_Ushort_Ushort_CBool(delegate* unmanaged<void*, ushort, ushort, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_Byte_Byte_Byte_CBool
    {
        public delegate* unmanaged<void*, byte, byte, byte, CBool> Pointer;

        public FnPtr_VoidPtr_Byte_Byte_Byte_CBool(delegate* unmanaged<void*, byte, byte, byte, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    {
        public delegate* unmanaged<void*, CBool> Pointer;

        public FnPtr_VoidPtr_CBool(delegate* unmanaged<void*, CBool> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLEGLAttribPtr
    {
        public delegate* unmanaged<void*, SDL_EGLAttrib*> Pointer;

        public FnPtr_VoidPtr_SDLEGLAttribPtr(delegate* unmanaged<void*, SDL_EGLAttrib*> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLEGLDisplay_SDLEGLConfig_SDLEGLintPtr
    {
        public delegate* unmanaged<void*, SDL_EGLDisplay, SDL_EGLConfig, SDL_EGLint*> Pointer;

        public FnPtr_VoidPtr_SDLEGLDisplay_SDLEGLConfig_SDLEGLintPtr(delegate* unmanaged<void*, SDL_EGLDisplay, SDL_EGLConfig, SDL_EGLint*> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_CString_CString_SDLEnumerationResult
    {
        public delegate* unmanaged<void*, CString, CString, SDL_EnumerationResult> Pointer;

        public FnPtr_VoidPtr_CString_CString_SDLEnumerationResult(delegate* unmanaged<void*, CString, CString, SDL_EnumerationResult> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_Long_SDLIOWhence_Long
    {
        public delegate* unmanaged<void*, long, SDL_IOWhence, long> Pointer;

        public FnPtr_VoidPtr_Long_SDLIOWhence_Long(delegate* unmanaged<void*, long, SDL_IOWhence, long> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    {
        public delegate* unmanaged<void*, long> Pointer;

        public FnPtr_VoidPtr_Long(delegate* unmanaged<void*, long> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLTimerID_Uint_Uint
    {
        public delegate* unmanaged<void*, SDL_TimerID, uint, uint> Pointer;

        public FnPtr_VoidPtr_SDLTimerID_Uint_Uint(delegate* unmanaged<void*, SDL_TimerID, uint, uint> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_SDLTimerID_Ulong_Ulong
    {
        public delegate* unmanaged<void*, SDL_TimerID, ulong, ulong> Pointer;

        public FnPtr_VoidPtr_SDLTimerID_Ulong_Ulong(delegate* unmanaged<void*, SDL_TimerID, ulong, ulong> pointer)
        {
            Pointer = pointer;
        }
    }
    ...
    public struct FnPtr_VoidPtr_Ulong
    {
        ...
        public FnPtr_VoidPtr_Ulong(delegate* unmanaged<void*, ulong> pointer)
        {
            Pointer = pointer;
        }
    }
